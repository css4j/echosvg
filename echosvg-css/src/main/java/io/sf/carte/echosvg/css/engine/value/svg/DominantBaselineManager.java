...
public class DominantBaselineManager extends IdentifierManager {
	...
	static {
		...
		values.put(CSSConstants.CSS_CENTRAL_VALUE, SVGValueConstants.CENTRAL_VALUE);
		...
		values.put(CSSConstants.CSS_RESET_SIZE_VALUE, SVGValueConstants.RESET_SIZE_VALUE);
		...
		values.put(CSSConstants.CSS_USE_SCRIPT_VALUE, SVGValueConstants.USE_SCRIPT_VALUE);
	}
