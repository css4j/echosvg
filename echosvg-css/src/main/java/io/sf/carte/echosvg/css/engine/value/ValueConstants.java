...
public interface ValueConstants {
	 ...
	 * The 'all' keyword.
	 */
	Value ALL_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_ALL_VALUE);
	 ...
	 */
	Value BIDI_OVERRIDE_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_BIDI_OVERRIDE_VALUE);
	 ...
	 * The 'compact' keyword.
	 */
	Value COMPACT_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_COMPACT_VALUE);

	/**
	 * The 'condensed' keyword.
	 */
	Value CONDENSED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_CONDENSED_VALUE);

	/**
	 * The 'crispedges' keyword.
	 */
	Value CRISPEDGES_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_CRISPEDGES_VALUE);
	 ...
	 */
	Value EXPANDED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_EXPANDED_VALUE);

	/**
	 * The 'extra-condensed' keyword.
	 */
	Value EXTRA_CONDENSED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_EXTRA_CONDENSED_VALUE);

	/**
	 * The 'extra-expanded' keyword.
	 */
	Value EXTRA_EXPANDED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_EXTRA_EXPANDED_VALUE);
	 ...
	 * The 'help' keyword.
	 */
	Value HELP_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_HELP_VALUE);
	 ...
	 * The 'marker' keyword.
	 */
	Value MARKER_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_MARKER_VALUE);
	 ...
	 */
	Value NARROWER_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_NARROWER_VALUE);
	 ...
	 * The 'painted' keyword.
	 */
	Value PAINTED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_PAINTED_VALUE);
	 ...
	 */
	Value SEMI_CONDENSED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_SEMI_CONDENSED_VALUE);

	/**
	 * The 'semi-expanded' keyword.
	 */
	Value SEMI_EXPANDED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_SEMI_EXPANDED_VALUE);
	 ...
	 * The 'stroke' keyword.
	 */
	Value STROKE_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_STROKE_VALUE);
	 ...
	 */
	Value ULTRA_CONDENSED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_ULTRA_CONDENSED_VALUE);

	/**
	 * The 'ultra-expanded' keyword.
	 */
	Value ULTRA_EXPANDED_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_ULTRA_EXPANDED_VALUE);
	 ...
	 * The 'wider' keyword.
	 */
	Value WIDER_VALUE = new StringValue(CSSPrimitiveValue.CSS_IDENT, CSSConstants.CSS_WIDER_VALUE);
