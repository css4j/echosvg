...
public class CSSOMValue implements CSSPrimitiveValue, CSSValueList, Counter, Rect, RGBColor {
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.css.CSSPrimitiveValue#getPrimitiveType()}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.css.CSSPrimitiveValue#getFloatValue(short)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.css.CSSPrimitiveValue#setStringValue(short,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.css.CSSPrimitiveValue#getStringValue()}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.css.CSSPrimitiveValue#getCounterValue()}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.css.CSSPrimitiveValue#getRectValue()}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.css.CSSPrimitiveValue#getRGBColorValue()}.
	 */
	@Override
	...
	public abstract static class AbstractModificationHandler implements ModificationHandler {
		...
		public void leftTextChanged(String text) throws DOMException {
			...
			text = "rect(" + val.getTop().getCssText() + ", " + val.getRight().getCssText() + ", "
					+ val.getBottom().getCssText() + ", " + text + ')';
			textChanged(text);
		}
		...
		public void leftFloatValueChanged(short unit, float value) throws DOMException {
			final Value val = getValue();
			String text = "rect(" + val.getTop().getCssText() + ", " + val.getRight().getCssText() + ", "
					+ val.getBottom().getCssText() + ", " + FloatValue.getCssText(unit, value) + ')';
			textChanged(text);
		}
		...
		public void topTextChanged(String text) throws DOMException {
			final Value val = getValue();
			text = "rect(" + text + ", " + val.getRight().getCssText() + ", " + val.getBottom().getCssText() + ", "
		...
		public void topFloatValueChanged(short unit, float value) throws DOMException {
			final Value val = getValue();
			String text = "rect(" + FloatValue.getCssText(unit, value) + ", " + val.getRight().getCssText() + ", "
					+ val.getBottom().getCssText() + ", " + val.getLeft().getCssText() + ')';
			textChanged(text);
		}
		...
		public void rightTextChanged(String text) throws DOMException {
			final Value val = getValue();
			text = "rect(" + val.getTop().getCssText() + ", " + text + ", " + val.getBottom().getCssText() + ", "
					+ val.getLeft().getCssText() + ')';
			textChanged(text);
		}
		...
		public void rightFloatValueChanged(short unit, float value) throws DOMException {
			final Value val = getValue();
			String text = "rect(" + val.getTop().getCssText() + ", " + FloatValue.getCssText(unit, value) + ", "
					+ val.getBottom().getCssText() + ", " + val.getLeft().getCssText() + ')';
			textChanged(text);
		}
		...
		public void bottomTextChanged(String text) throws DOMException {
			final Value val = getValue();
			text = "rect(" + val.getTop().getCssText() + ", " + val.getRight().getCssText() + ", " + text + ", "
					+ val.getLeft().getCssText() + ')';
			textChanged(text);
		}
		...
		public void bottomFloatValueChanged(short unit, float value) throws DOMException {
			final Value val = getValue();
			String text = "rect(" + val.getTop().getCssText() + ", " + val.getRight().getCssText() + ", "
					+ FloatValue.getCssText(unit, value) + ", " + val.getLeft().getCssText() + ')';
			textChanged(text);
		}
