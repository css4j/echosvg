 ...
 * render an SVG document. see the <code>{@link io.sf.carte.echosvg.gvt}
 ...
 * <code>{@link io.sf.carte.echosvg.bridge.UpdateManagerListener}</code>.</p>
 *
...
public class JSVGComponent extends JGVTComponent {
     ...
     * EchoSVG's SVG DOM Implemenation it will be cloned into that
     ...
     * In many cases you also need to tell EchoSVG to treat the document
