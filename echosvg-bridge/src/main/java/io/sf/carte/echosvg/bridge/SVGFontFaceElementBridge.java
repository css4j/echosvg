...
public class SVGFontFaceElementBridge extends AbstractSVGBridge implements ErrorConstants {
	...
	/**
	 * Creates an SVGFontFace that repesents the specified &lt;font-face&gt;
	 * element.
	 *
	...
	public SVGFontFace createFontFace(BridgeContext ctx, Element fontFaceElement) {
		...
		return new SVGFontFace(fontFaceElement, srcs, familyNames, unitsPerEm, fontWeight, fontStyle, fontVariant,
				fontStretch, slope, panose1, ascent, descent, strikethroughPos, strikethroughThickness, underlinePos,
				underlineThickness, overlinePos, overlineThickness);
	}
