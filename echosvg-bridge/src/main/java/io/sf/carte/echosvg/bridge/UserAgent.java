...
public interface UserAgent {
	...
	/**
	 * Sets the <code>AffineTransform</code> currently applied to the drawing by the
	 * UserAgent.
	 */
	...
	/**
	 * This method should return an image to be displayed when an image can't be
	 * loaded. If it returns 'null' then a BridgeException will be thrown.
	 *
