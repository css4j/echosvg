...
/**
 * Bridge context for SVG 1.2 documents. This is primarily for dispatching XBL
 * events to bridges and for handling resource documents.
 *
...
public class SVG12BridgeContext extends BridgeContext {
	...
	/**
	 * Whether the mouse capture event target will receive events that do not
	...
	/**
	 * Adds a BindingListener to the XBLManager for the document, so that XBL
	 * binding events can be passed on to the BridgeUpdateHandlers.
	 */
	 ...
	 * GVT tree in response. This overriden method adds implementation event
	 * listeners, so that mutations in shadow trees can be caught.
	 */
	@Override
	public void addDOMListeners() {
		...
		domAttrModifiedEventListener = new EventListenerWrapper(new DOMAttrModifiedEventListener());
		evtSupport.addImplementationEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMAttrModified",
				domAttrModifiedEventListener, true);

		domNodeInsertedEventListener = new EventListenerWrapper(new DOMNodeInsertedEventListener());
		evtSupport.addImplementationEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMNodeInserted",
				domNodeInsertedEventListener, true);

		domNodeRemovedEventListener = new EventListenerWrapper(new DOMNodeRemovedEventListener());
		...
		domCharacterDataModifiedEventListener = new EventListenerWrapper(new DOMCharacterDataModifiedEventListener());
		evtSupport.addImplementationEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMCharacterDataModified",
	...
	public void addUIEventListeners(Document doc) {
		...
		EventListener domMouseOverListener = new EventListenerWrapper(new DOMMouseOverEventListener());
		evtSupport.addImplementationEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI,
				SVGConstants.SVG_EVENT_MOUSEOVER, domMouseOverListener, true);
		storeImplementationEventListenerNS(evtTarget, XMLConstants.XML_EVENTS_NAMESPACE_URI,
				SVGConstants.SVG_EVENT_MOUSEOVER, domMouseOverListener, true);

		EventListener domMouseOutListener = new EventListenerWrapper(new DOMMouseOutEventListener());
		evtSupport.addImplementationEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI,
				SVGConstants.SVG_EVENT_MOUSEOUT, domMouseOutListener, true);
		storeImplementationEventListenerNS(evtTarget, XMLConstants.XML_EVENTS_NAMESPACE_URI,
				SVGConstants.SVG_EVENT_MOUSEOUT, domMouseOutListener, true);
	}
	...
	/**
	 * Adds to the eventListenerSet the specified implementation event listener
	 * registration.
	 */
	...
	protected static class ImplementationEventListenerMememto extends EventListenerMememto {
		 ...
		 */
		public ImplementationEventListenerMememto(EventTarget t, String s, EventListener l, boolean b,
				BridgeContext c) {
			super(t, s, l, b, c);
		}
		 ...
		 * Creates a new ImplementationEventListenerMememto.
		 */
		public ImplementationEventListenerMememto(EventTarget t, String n, String s, EventListener l, boolean b,
				BridgeContext c) {
			super(t, n, s, l, b, c);
		}
	}
