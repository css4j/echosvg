...
public abstract class TextUtilities implements CSSConstants, ErrorConstants {
	...
	/**
	 * Returns the float list that represents a set of horizontal values or
	 * percentage.
	 *
	 ...
	 */
	public static ArrayList<Float> svgHorizontalCoordinateArrayToUserSpace(Element element, String attrName,
			String valueStr, BridgeContext ctx) {
	 ...
	 * @param ctx      the bridge context
	 */
	public static ArrayList<Float> svgVerticalCoordinateArrayToUserSpace(Element element, String attrName,
			String valueStr, BridgeContext ctx) {
	...
	public static ArrayList<Float> svgRotateArrayToFloats(Element element, String attrName, String valueStr,
			BridgeContext ctx) {
		...
		while (st.hasMoreTokens()) {
			try {
				...
				throw new BridgeException(ctx, element, nfEx, ERR_ATTRIBUTE_VALUE_MALFORMED,
	...
	public static Float convertFontSize(Element e) {
		Value v = CSSUtilities.getComputedStyle(e, SVGCSSEngine.FONT_SIZE_INDEX);
	...
	/**
	 * Converts a baseline-shift CSS value to a value usable as a text attribute, or
	 * null.
	 * 
	 * @param e the element
	 */
	...
	/**
	 * Converts a letter-spacing CSS value to a value usable as a text attribute, or
	 * null.
	 * 
	 * @param e the element
	 */
	...
	/**
	 * Converts a word-spacing CSS value to a value usable as a text attribute, or
	 * null.
	 * 
	 * @param e the element
	 */
