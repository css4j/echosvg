...
import io.sf.carte.echosvg.ext.awt.image.renderable.ColorMatrixRable8Bit;
...
public class SVGFeColorMatrixElementBridge extends AbstractSVGFilterPrimitiveElementBridge {
	...
	/**
	 * Converts the 'values' attribute of the specified feColorMatrix filter
	 * primitive element for the 'matrix' type.
	 *
	...
	/**
	 * Converts the 'values' attribute of the specified feColorMatrix filter
	 * primitive element for the 'saturate' type.
	 *
	 * @param filterElement the filter element
	 * @param ctx           the BridgeContext to use for error information
	 */
	...
	/**
	 * Converts the 'values' attribute of the specified feColorMatrix filter
	 * primitive element for the 'hueRotate' type.
	 *
	 * @param filterElement the filter element
	 * @param ctx           the BridgeContext to use for error information
	 */
