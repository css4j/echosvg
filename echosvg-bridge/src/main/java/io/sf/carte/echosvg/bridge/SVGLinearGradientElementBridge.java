...
import io.sf.carte.echosvg.ext.awt.LinearGradientPaint;
...
public class SVGLinearGradientElementBridge extends AbstractSVGGradientElementBridge {
	...
	protected Paint buildGradient(Element paintElement, Element paintedElement, GraphicsNode paintedNode,
		...
		Point2D p1 = SVGUtilities.convertPoint(x1Str, SVG_X1_ATTRIBUTE, y1Str, SVG_Y1_ATTRIBUTE, coordSystemType, uctx);

		Point2D p2 = SVGUtilities.convertPoint(x2Str, SVG_X2_ATTRIBUTE, y2Str, SVG_Y2_ATTRIBUTE, coordSystemType, uctx);
