...
public class DocumentLoader {
	...
	/**
	 * Returns the line in the source code of the specified element or -1 if not
	 * found.
	 *
	 * @param e the element
	 * @return -1 the document has been removed from the cache or has not been
	 *         loaded by this document loader.
	 */
