...
public class UpdateManagerEvent extends EventObject {
	...
	/**
	 * True if before painting this update the canvas's painting transform needs to
	 * be cleared.
	 */
	 ...
	 * 
	 * @param source the object that originated the event, ie. the UpdateManager.
	 * @param bi     the image to paint.
	 * @param das    List of dirty areas.
	 */
	public UpdateManagerEvent(Object source, BufferedImage bi, List<Rectangle> das) {
		super(source);
		this.image = bi;
		this.dirtyAreas = das;
	 ...
	 * @param bi     the image to paint.
	 * @param das    List of dirty areas.
	 * @param cpt    Indicates if the painting transform should be cleared as a
	 *               result of this event.
	 */
	public UpdateManagerEvent(Object source, BufferedImage bi, List<Rectangle> das, boolean cpt) {
		super(source);
		this.image = bi;
		this.dirtyAreas = das;
	...
	/**
	 * returns true if the component should clear it's painting transform before
	 * painting the associated BufferedImage.
	 */
