...
public class ScriptingEnvironment extends BaseScriptingEnvironment {
	...
	public static final String[] SVG_EVENT_ATTRS = { "onabort", // SVG element
			"onerror", // SVG element
	...
	public static final String[] SVG_DOM_EVENT = { "SVGAbort", // SVG element
	...
	protected EventListener[] listeners = { svgAbortListener, svgErrorListener, svgResizeListener, svgScrollListener,
			svgUnloadListener, svgZoomListener,

			beginListener, endListener, repeatListener,

			focusinListener, focusoutListener, activateListener, clickListener,

			mousedownListener, mouseupListener, mouseoverListener, mouseoutListener, mousemoveListener,

			keypressListener, keydownListener, keyupListener };
	...
	protected void addDocumentListeners() {
		...
		et.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMNodeInserted", domNodeInsertedListener, false,
				null);
		et.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMNodeRemoved", domNodeRemovedListener, false,
				null);
		et.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMAttrModified", domAttrModifiedListener, false,
				null);
	}
	...
	protected void removeDocumentListeners() {
		NodeEventTarget et = (NodeEventTarget) document;
		et.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMNodeInserted", domNodeInsertedListener,
				false);
		et.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMNodeRemoved", domNodeRemovedListener,
				false);
		et.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMAttrModified", domAttrModifiedListener,
				false);
	}
	...
	protected void addScriptingListenersOn(Element elt) {
		...
		if (SVGConstants.SVG_NAMESPACE_URI.equals(elt.getNamespaceURI())) {
			if (SVGConstants.SVG_SVG_TAG.equals(elt.getLocalName())) {
				...
				if (elt.hasAttributeNS(null, "onabort")) {
					target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGAbort", svgAbortListener,
							false, null);
				}
				if (elt.hasAttributeNS(null, "onerror")) {
					target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGError", svgErrorListener,
							false, null);
				}
				if (elt.hasAttributeNS(null, "onresize")) {
					target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGResize", svgResizeListener,
							false, null);
				}
				if (elt.hasAttributeNS(null, "onscroll")) {
					target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGScroll", svgScrollListener,
							false, null);
				}
				if (elt.hasAttributeNS(null, "onunload")) {
					target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGUnload", svgUnloadListener,
							false, null);
				}
				if (elt.hasAttributeNS(null, "onzoom")) {
					target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGZoom", svgZoomListener, false,
							null);
				}
			} else {
				...
				if (name.equals(SVGConstants.SVG_SET_TAG) || name.startsWith("animate")) {
					...
					if (elt.hasAttributeNS(null, "onbegin")) {
						target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "beginEvent", beginListener,
								false, null);
					}
					if (elt.hasAttributeNS(null, "onend")) {
						target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "endEvent", endListener, false,
								null);
					}
					if (elt.hasAttributeNS(null, "onrepeat")) {
						target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "repeatEvent", repeatListener,
								false, null);
					}
					return;
				}
		...
		if (elt.hasAttributeNS(null, "onfocusin")) {
			target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMFocusIn", focusinListener, false,
					null);
		}
		if (elt.hasAttributeNS(null, "onfocusout")) {
			target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMFocusOut", focusoutListener, false,
					null);
		}
		if (elt.hasAttributeNS(null, "onactivate")) {
			target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMActivate", activateListener, false,
					null);
		}
		...
		if (elt.hasAttributeNS(null, "onmousedown")) {
			target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "mousedown", mousedownListener, false,
					null);
		}
		...
		if (elt.hasAttributeNS(null, "onmouseover")) {
			target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "mouseover", mouseoverListener, false,
					null);
		}
		...
		if (elt.hasAttributeNS(null, "onmousemove")) {
			target.addEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "mousemove", mousemoveListener, false,
					null);
		}
	...
	/**
	 * Removes the scripting listeners from the given element and all of its
	 * descendants.
	 */
	...
	protected void removeScriptingListenersOn(Element elt) {
		...
		if (SVGConstants.SVG_NAMESPACE_URI.equals(elt.getNamespaceURI())) {
			if (SVGConstants.SVG_SVG_TAG.equals(elt.getLocalName())) {
				// <svg> listeners
				target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGAbort", svgAbortListener,
						false);
				target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGError", svgErrorListener,
						false);
				target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGResize", svgResizeListener,
						false);
				target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGScroll", svgScrollListener,
						false);
				target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "SVGUnload", svgUnloadListener,
						false);
				...
				if (name.equals(SVGConstants.SVG_SET_TAG) || name.startsWith("animate")) {
					// animation listeners
					target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "beginEvent", beginListener,
							false);
					target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "endEvent", endListener, false);
					target.removeEventListenerNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "repeatEvent", repeatListener,
							false);
					return;
				}
			}
	 ...
	 */
	protected class Window implements io.sf.carte.echosvg.bridge.Window {

		/**
		 * A <code>TimerTask</code> to invoke a <code>setInterval()</code>-scheduled
		 * function that is specified by a String.
		 */
		...
		/**
		 * A <code>TimerTask</code> to invoke a <code>setInterval()</code>-scheduled
		 * function that is specified by a <code>Runnable</code>.
		 */
		...
		/**
		 * A <code>TimerTask</code> to invoke a <code>setTimeout()</code>-scheduled
		 * function that is specified by a String.
		 */
		...
		/**
		 * A <code>TimerTask</code> to invoke a <code>setTimeout()</code>-scheduled
		 * function that is specified by a Runnable.
		 */
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.bridge.Window#setInterval(String,long)}.
		 */
		@Override
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.bridge.Window#setInterval(Runnable,long)}.
		 */
		@Override
		...
		/**
		 * Implements {@link io.sf.carte.echosvg.bridge.Window#clearInterval(Object)}.
		 */
		@Override
		...
		/**
		 * Implements {@link io.sf.carte.echosvg.bridge.Window#setTimeout(String,long)}.
		 */
		@Override
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.bridge.Window#setTimeout(Runnable,long)}.
		 */
		@Override
		...
		/**
		 * Implements {@link io.sf.carte.echosvg.bridge.Window#clearTimeout(Object)}.
		 */
		@Override
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.bridge.Window#parseXML(String,Document)}.
		 */
		@Override
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.bridge.Window#getURL(String,io.sf.carte.echosvg.bridge.Window.URLResponseHandler)}.
		 */
		@Override
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.bridge.Window#getURL(String,io.sf.carte.echosvg.bridge.Window.URLResponseHandler,String)}.
		 */
		@Override
		public void getURL(final String uri, final io.sf.carte.echosvg.bridge.Window.URLResponseHandler h,
				final String enc) {
			Thread t = new Thread() {
				@Override
				public void run() {
		...
		@Override
		public void postURL(String uri, String content, io.sf.carte.echosvg.bridge.Window.URLResponseHandler h) {
		...
		@Override
		public void postURL(final String uri, final String content,
				final io.sf.carte.echosvg.bridge.Window.URLResponseHandler h, final String mimeType,
				final String fEnc) {
			Thread t = new Thread() {
				@Override
				public void run() {
	...
	protected class ScriptingEventListener implements EventListener {
		...
		public void handleEvent(Event evt) {
			...
			final String desc = Messages.formatMessage(EVENT_SCRIPT_DESCRIPTION,
