...
public class SVGFontElementBridge extends AbstractSVGBridge {
	...
	/**
	 * Constructs a new SVGGVTFont that represents the specified &lt;font&gt;
	 ...
	 */
	public SVGGVTFont createFont(BridgeContext ctx, Element fontElement, Element textElement, float size,
			GVTFontFace fontFace) {

		// construct a list of glyph codes that this font can display and
		// a list of the glyph elements
		NodeList glyphElements = fontElement.getElementsByTagNameNS(SVG_NAMESPACE_URI, SVG_GLYPH_TAG);
		...
		NodeList missingGlyphElements = fontElement.getElementsByTagNameNS(SVG_NAMESPACE_URI, SVG_MISSING_GLYPH_TAG);
		...
		NodeList hkernElements = fontElement.getElementsByTagNameNS(SVG_NAMESPACE_URI, SVG_HKERN_TAG);
		...
		NodeList vkernElements = fontElement.getElementsByTagNameNS(SVG_NAMESPACE_URI, SVG_VKERN_TAG);
