...
public class SVGFeConvolveMatrixElementBridge extends AbstractSVGFilterPrimitiveElementBridge {
	...
	/**
	 * Convert the 'order' attribute of the specified feConvolveMatrix filter
	 * primitive element.
	 *
	...
	/**
	 * Convert the 'kernelMatrix' attribute of the specified feConvolveMatrix filter
	 * primitive element.
	 *
	 * @param filterElement the feConvolveMatrix filter primitive element
	...
	/**
	 * Convert the 'divisor' attribute of the specified feConvolveMatrix filter
	 * primitive element.
	 *
	 * @param filterElement the feConvolveMatrix filter primitive element
	...
	/**
	 * Convert the 'kernelUnitLength' attribute of the specified feConvolveMatrix
