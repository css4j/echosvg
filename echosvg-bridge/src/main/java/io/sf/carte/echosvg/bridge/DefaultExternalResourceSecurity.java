...
/**
 * Default implementation for the <code>ExternalResourceSecurity</code>
 * interface. It allows all types of external resources to be loaded, but only
 * if they come from the same server as the document they are referenced from.
 *
...
public class DefaultExternalResourceSecurity implements ExternalResourceSecurity {
	...
	/**
	 * Message when trying to load a externalResource file from a server different
	 * than the one of the document.
	 */
