...
public class GVTBuilder implements SVGConstants {
	 ...
	 * @exception BridgeException if an error occured while constructing the GVT
	 *                            tree
	 */
	 ...
	 * @param ctx        the bridge context
	 * @param e          the element to build
	 * @param parentNode the composite graphics node, parent of the graphics node to
	 *                   build
	 * @exception BridgeException if an error occured while constructing the GVT
	 *                            tree
	 */
	...
	/**
	 * Handles any GenericBridge elements which are children of the specified
	 * element.
	 * 
	 * @param ctx the bridge context
