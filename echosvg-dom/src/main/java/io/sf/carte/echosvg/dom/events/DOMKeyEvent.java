...
public class DOMKeyEvent extends DOMUIEvent {
	...
	/**
	 * Returns the virtual key code value of the key which was depressed if the
	 * event is a key event. Otherwise, the value returned is zero.
	 */
	...
	/**
	 * Returns the value of the Unicode character associated with the depressed key
	 ...
	 *                      the <code>Event</code>.
	 * @param shiftKeyArg   Specifies whether or not shift key was depressed during
	 *                      the <code>Event</code>.
	 ...
	 * @param charCodeArg   Specifies the <code>Event</code>'s <code>charCode</code>
	 * @param viewArg       Specifies the <code>Event</code>'s
	 *                      <code>AbstractView</code>.
	 */
	public void initKeyEvent(String typeArg, boolean canBubbleArg, boolean cancelableArg, boolean ctrlKeyArg,
			boolean altKeyArg, boolean shiftKeyArg, boolean metaKeyArg, int keyCodeArg, int charCodeArg,
