...
public abstract class AbstractText extends AbstractCharacterData implements Text {
	...
	public Text splitText(int offset) throws DOMException {
		...
		if (n == null) {
			throw createDOMException(DOMException.INDEX_SIZE_ERR, "need.parent", new Object[] {});
		}
	...
	/**
	 * Get the previous <a href=
	 * "http://www.w3.org/TR/2004/REC-DOM-Level-3-Core-20040407/glossary.html#dt-logically-adjacent-text-nodes">logically
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Text#isElementContentWhitespace()}.
	 */
	@Override
	...
	public Text replaceWholeText(String s) throws DOMException {
		for (Node n = getPreviousLogicallyAdjacentTextNode(this); n != null; n = getPreviousLogicallyAdjacentTextNode(
				n)) {
