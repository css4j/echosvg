...
/**
 * The UIEvent class provides specific contextual information associated with
...
public class DOMUIEvent extends AbstractEvent implements UIEvent {
	...
	/**
	 * DOM: The <code>view</code> attribute identifies the <code>AbstractView</code>
	...
	/**
	 * DOM: Specifies some detail information about the <code>Event</code>,
	...
	/**
	 * DOM: The <code>initUIEvent</code> method is used to initialize the value of a
	 * <code>UIEvent</code> created through the <code>DocumentEvent</code>
	 * interface. This method may only be called before the <code>UIEvent</code> has
	 ...
	 */
	public void initUIEventNS(String namespaceURIArg, String typeArg, boolean canBubbleArg, boolean cancelableArg,
