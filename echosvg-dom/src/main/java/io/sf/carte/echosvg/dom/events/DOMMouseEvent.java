...
/**
 * The MouseEvent class provides specific contextual information associated with
 * Mouse events.
 *
...
public class DOMMouseEvent extends DOMUIEvent implements MouseEvent {
	...
	/**
	 * DOM: <code>screenX</code> indicates the horizontal coordinate at which the
	...
	/**
	 * DOM: <code>screenY</code> indicates the vertical coordinate at which the
	 * event occurred relative to the origin of the screen coordinate system.
	 */
	@Override
	...
	/**
	 * DOM: <code>clientX</code> indicates the horizontal coordinate at which the
	...
	/**
	 * DOM: <code>clientY</code> indicates the vertical coordinate at which the
	 * event occurred relative to the DOM implementation's client area.
	 */
	@Override
	...
	/**
	 * DOM: <code>ctrlKey</code> indicates whether the 'ctrl' key was depressed
	...
	/**
	 * DOM: <code>shiftKey</code> indicates whether the 'shift' key was depressed
	 * during the firing of the event.
	 */
	@Override
	...
	/**
	 * DOM: <code>altKey</code> indicates whether the 'alt' key was depressed during
	 * the firing of the event. On some platforms this key may map to an alternative
	 * key name.
	 */
	@Override
	...
	/**
	 * DOM: <code>metaKey</code> indicates whether the 'meta' key was depressed
	...
	/**
	 * DOM: During mouse events caused by the depression or release of a mouse
	 * button, <code>button</code> is used to indicate which mouse button changed
	 * state. The values for <code>button</code> range from zero to indicate the
	 * left button of the mouse, one to indicate the middle button if present, and
	 * two to indicate the right button. For mice configured for left handed use in
	 * which the button actions are reversed the values are instead read from right
	 * to left.
	 */
	@Override
	...
	/**
	 * DOM: Used to identify a secondary <code>EventTarget</code> related to a UI
	 * event. Currently this attribute is used with the mouseover event to indicate
	 * the <code>EventTarget</code> which the pointing device exited and with the
	 * mouseout event to indicate the <code>EventTarget</code> which the pointing
	 * device entered.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Returns whether the given modifier key was pressed at the time of
	 * the event.
	 */
	...
	/**
	 * DOM: The <code>initMouseEvent</code> method is used to initialize the value
	 * of a <code>MouseEvent</code> created through the <code>DocumentEvent</code>
	 * interface. This method may only be called before the <code>MouseEvent</code>
	 * has been dispatched via the <code>dispatchEvent</code> method, though it may
	 * be called multiple times during that phase if necessary. If called multiple
	 ...
	 */
	public void initMouseEventNS(String namespaceURIArg, String typeArg, boolean canBubbleArg, boolean cancelableArg,
