...
public abstract class AbstractElement extends AbstractParentChildNode implements Element, ElementTraversal {
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.Element#setAttribute(String,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Element#removeAttribute(String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Element#getAttributeNode(String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Element#setAttributeNode(Attr)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Element#removeAttributeNode(Attr)}.
	 */
	@Override
	public Attr removeAttributeNode(Attr oldAttr) throws DOMException {
		...
		if (attributes == null) {
			throw createDOMException(DOMException.NOT_FOUND_ERR, "attribute.missing",
					new Object[] { oldAttr.getName() });
		}
		String nsURI = oldAttr.getNamespaceURI();
		return (Attr) attributes.removeNamedItemNS(nsURI,
				(nsURI == null ? oldAttr.getNodeName() : oldAttr.getLocalName()));
	}
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.Element#hasAttributeNS(String,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.Element#getAttributeNS(String,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.Element#setAttributeNS(String,String,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.Element#removeAttributeNS(String,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.Element#getAttributeNodeNS(String,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Element#setAttributeNodeNS(Attr)}.
	 */
	@Override
	...
	public void setIdAttribute(String name, boolean isId) throws DOMException {
		...
		if (a == null) {
			throw createDOMException(DOMException.NOT_FOUND_ERR, "attribute.missing", new Object[] { name });
		}
		if (a.isReadonly()) {
			throw createDOMException(DOMException.NO_MODIFICATION_ALLOWED_ERR, "readonly.node", new Object[] { name });
		}
	...
	public void setIdAttributeNS(String ns, String ln, boolean isId) throws DOMException {
		...
		if (a == null) {
			throw createDOMException(DOMException.NOT_FOUND_ERR, "attribute.missing", new Object[] { ns, ln });
		}
		if (a.isReadonly()) {
	...
	/**
	 * Fires a DOMAttrModified event. WARNING: public accessor because of
	 * compilation problems on Solaris. Do not change.
	 *
	...
	public void fireDOMAttrModifiedEvent(String name, Attr node, String oldv, String newv, short change) {
		...
		if (doc.getEventsEnabled() && !oldv.equals(newv)) {
			...
			ev.initMutationEventNS(XMLConstants.XML_EVENTS_NAMESPACE_URI, "DOMAttrModified", true, // canBubbleArg
					false, // cancelableArg
					node, // relatedNodeArg
					oldv, // prevValueArg
					newv, // newValueArg
	 ...
	 *
	 * <br>
	 * This Map is not Thread-safe, concurrent updates or reading while updating may
	...
	public class NamedNodeHashMap implements NamedNodeMap, Serializable {
		...
		/**
		 * <b>DOM</b>: Implements
		 * {@link org.w3c.dom.NamedNodeMap#removeNamedItem(String)}.
		 */
		@Override
		...
		/**
		 * <b>DOM</b>: Implements
		 * {@link org.w3c.dom.NamedNodeMap#getNamedItemNS(String,String)}.
		 */
		@Override
		...
		public Node setNamedItemNS(Node arg) throws DOMException {
			...
			return setNamedItem(nsURI, (nsURI == null) ? arg.getNodeName() : arg.getLocalName(), arg);
		}

		/**
		 * <b>DOM</b>: Implements
		 * {@link org.w3c.dom.NamedNodeMap#removeNamedItemNS(String,String)}.
		 */
		@Override
		...
		public Node setNamedItem(String ns, String name, Node arg) throws DOMException {
			...
			if (result != null) {
				...
				fireDOMAttrModifiedEvent(name, result, result.getNodeValue(), "", MutationEvent.REMOVAL);
			}
			fireDOMAttrModifiedEvent(name, (Attr) arg, "", arg.getNodeValue(), MutationEvent.ADDITION);
			return result;
		}
		...
		protected void checkNode(Node arg) {
			...
			if (getOwnerDocument() != arg.getOwnerDocument()) {
				throw createDOMException(DOMException.WRONG_DOCUMENT_ERR, "node.from.wrong.document",
						new Object[] { (int) arg.getNodeType(), arg.getNodeName() });
			}
			if (arg.getNodeType() == ATTRIBUTE_NODE && ((Attr) arg).getOwnerElement() != null) {
				throw createDOMException(DOMException.WRONG_DOCUMENT_ERR, "inuse.attribute",
	...
	/**
	 * To manage collisions in the attributes map. Implements a linked list of
