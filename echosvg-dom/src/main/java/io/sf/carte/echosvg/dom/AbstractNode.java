...
public abstract class AbstractNode implements ExtendedNode, NodeXBL, XBLManagerData, Serializable {
	...
	public void setSpecified(boolean v) {
		throw createDOMException(DOMException.INVALID_STATE_ERR, "node.type",
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#setNodeValue(String)}. Do
	 * nothing.
	 */
	@Override
	...
	/**
	 * Sets the parent node. Throws a HIERARCHY_REQUEST_ERR
	 * {@link org.w3c.dom.DOMException}.
	 */
	@Override
	public void setParentNode(Node v) {
		throw createDOMException(DOMException.HIERARCHY_REQUEST_ERR, "parent.not.allowed",
				new Object[] { (int) getNodeType(), getNodeName() });
	}
	...
	/**
	 * Sets the node immediately preceding this node. Throws a HIERARCHY_REQUEST_ERR
	 * {@link org.w3c.dom.DOMException}.
	 */
	@Override
	public void setPreviousSibling(Node n) {
		throw createDOMException(DOMException.HIERARCHY_REQUEST_ERR, "sibling.not.allowed",
				new Object[] { (int) getNodeType(), getNodeName() });
	}
	...
	/**
	 * Sets the node immediately following this node. Throws a HIERARCHY_REQUEST_ERR
	 * {@link org.w3c.dom.DOMException}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#insertBefore(Node, Node)}.
	 * Throws a HIERARCHY_REQUEST_ERR {@link org.w3c.dom.DOMException}.
	 */
	@Override
	public Node insertBefore(Node newChild, Node refChild) throws DOMException {
		throw createDOMException(DOMException.HIERARCHY_REQUEST_ERR, "children.not.allowed",
				new Object[] { (int) getNodeType(), getNodeName() });
	}

	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#replaceChild(Node, Node)}.
	 * Throws a HIERARCHY_REQUEST_ERR {@link org.w3c.dom.DOMException}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#removeChild(Node)}. Throws a
	 * HIERARCHY_REQUEST_ERR {@link org.w3c.dom.DOMException}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#appendChild(Node)}. Throws a
	 * HIERARCHY_REQUEST_ERR {@link org.w3c.dom.DOMException}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#normalize()}. Do nothing.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#isSupported(String,String)}.
	 */
	@Override
	...
	public void setPrefix(String prefix) throws DOMException {
		...
		if ((prefix.equals("xml") && !XMLConstants.XML_NAMESPACE_URI.equals(uri))
				|| (prefix.equals("xmlns") && !XMLConstants.XMLNS_NAMESPACE_URI.equals(uri))) {
			throw createDOMException(DOMException.NAMESPACE_ERR, "namespace.uri",
					new Object[] { (int) getNodeType(), getNodeName(), uri });
		}
	...
	public DOMException createDOMException(short type, String key, Object[] args) {
		try {
			return new DOMException(type, getCurrentDocument().formatMessage(key, args));
		} catch (Exception e) {
	 ...
	 * dependency on parent bases if needed.
	 */
	protected String getCascadedXMLBase(Node node) {
		...
		Attr attr = e.getAttributeNodeNS(XMLConstants.XML_NAMESPACE_URI, XMLConstants.XML_BASE_ATTRIBUTE);
		if (attr != null) {
			if (base == null) {
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.Node#compareDocumentPosition(Node)}. XXX Doesn't handle
	 * notation or entity nodes.
	 */
	@Override
	...
	protected String lookupNamespacePrefix(String namespaceURI, Element originalElement) {
		...
		if (nnm != null) {
			for (int i = 0; i < nnm.getLength(); i++) {
				...
				if (XMLConstants.XMLNS_PREFIX.equals(attr.getPrefix()) && attr.getNodeValue().equals(namespaceURI)) {
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#isDefaultNamespace(String)}.
	 */
	@Override
	public boolean isDefaultNamespace(String namespaceURI) {
		...
		case ELEMENT_NODE:
			...
			if (nnm != null) {
				for (int i = 0; i < nnm.getLength(); i++) {
					Node attr = nnm.item(i);
					if (XMLConstants.XMLNS_PREFIX.equals(attr.getLocalName())) {
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#lookupNamespaceURI(String)}.
	 */
	@Override
	public String lookupNamespaceURI(String prefix) {
		...
		case ELEMENT_NODE:
			/*
			 * String ns = getNamespaceURI(); if (ns != null && compareStrings(getPrefix(),
			 * prefix)) { return getNamespaceURI(); }
			 */
			NamedNodeMap nnm = getAttributes();
			if (nnm != null) {
				for (int i = 0; i < nnm.getLength(); i++) {
	...
	public boolean isEqualNode(Node other) {
		...
		if (nt != getNodeType() || !compareStrings(getNodeName(), other.getNodeName())
		...
		if (nt == Node.DOCUMENT_TYPE_NODE) {
			...
			if (!compareStrings(dt1.getPublicId(), dt2.getPublicId())
					...
					|| !compareStrings(dt1.getInternalSubset(), dt2.getInternalSubset())
	...
	/**
	 * <b>DOM</b>: Implements {@link org.w3c.dom.Node#getFeature(String,String)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.events.EventTarget#addEventListener(String,EventListener,boolean)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link NodeEventTarget#addEventListenerNS(String,String,EventListener,boolean,Object)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.events.EventTarget#removeEventListener(String,EventListener,boolean)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link NodeEventTarget#removeEventListenerNS(String,String,EventListener,boolean)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements <code>EventTarget#willTriggerNS(String,String)</code>
	...
	/**
	 * <b>DOM</b>: Implements
	 * <code>EventTarget.hasEventListenerNS(String,String)</code> from an old draft
	...
	/**
	 * Initializes the event support instance for this node if it has not been
