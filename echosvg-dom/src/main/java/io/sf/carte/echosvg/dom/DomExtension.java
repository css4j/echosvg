...
public interface DomExtension {
	...
	/**
	 * This method should update the DOMImplementation with support for the tags in
	 * this extension. In some rare cases it may be necessary to replace existing
	 * tag handlers, although this is discouraged.
	 *
