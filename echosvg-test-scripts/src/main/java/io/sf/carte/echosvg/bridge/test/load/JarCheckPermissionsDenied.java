...
public class JarCheckPermissionsDenied implements ScriptHandler {
	 ...
	 */
	protected static Object[][] basePermissions = { { "AllPermission", new AllPermission() },
			...
			{ "RuntimePermission accessClassInPackage.java.security",
					new RuntimePermission("accessClassInPackage.java.security") },
			{ "RuntimePermission defineClassInPackage.java.lang",
					new RuntimePermission("defineClassInPackage.java.lang") },
			...
			{ "SecurityPermission createAccessControlContext",
					new SerializablePermission("createAccessControlContext") },
