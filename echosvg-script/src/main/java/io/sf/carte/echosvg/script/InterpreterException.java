 ...
 * by an <code>Interpreter</code> interface implementation.
 *
...
public class InterpreterException extends RuntimeException {
	...
	/**
	 * Returns the line number where the error occurs. If this value is not known,
	 * returns -1.
	 */
	...
	/**
	 * Returns the column number where the error occurs. If this value is not known,
	 * returns -1.
	 */
	...
	/**
	 * Returns the embedded exception. If no embedded exception is set, returns
	 * null.
	 */
