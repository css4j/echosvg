 ...
 * @version $Id$
 */
public class SVGOMFEDisplacementMapElement extends SVGOMFilterPrimitiveStandardAttributes
	...
	static {
		...
		t.put(null, SVG_IN2_ATTRIBUTE, new TraitInformation(true, SVGTypes.TYPE_CDATA));
		t.put(null, SVG_SCALE_ATTRIBUTE, new TraitInformation(true, SVGTypes.TYPE_NUMBER));
		t.put(null, SVG_X_CHANNEL_SELECTOR_ATTRIBUTE, new TraitInformation(true, SVGTypes.TYPE_IDENT));
		t.put(null, SVG_Y_CHANNEL_SELECTOR_ATTRIBUTE, new TraitInformation(true, SVGTypes.TYPE_IDENT));
	 ...
	 */
	protected static final String[] CHANNEL_SELECTOR_VALUES = { "", SVG_R_VALUE, SVG_G_VALUE, SVG_B_VALUE,
			SVG_A_VALUE };
	...
	private void initializeLiveAttributes() {
		...
		xChannelSelector = createLiveAnimatedEnumeration(null, SVG_X_CHANNEL_SELECTOR_ATTRIBUTE,
				CHANNEL_SELECTOR_VALUES, (short) 4);
		yChannelSelector = createLiveAnimatedEnumeration(null, SVG_Y_CHANNEL_SELECTOR_ATTRIBUTE,
				CHANNEL_SELECTOR_VALUES, (short) 4);
	}
	...
	/**
	 * <b>DOM</b>: Implements {@link SVGFEDisplacementMapElement#getIn2()}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link org.w3c.dom.svg.SVGFEDisplacementMapElement#getScale()}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link SVGFEDisplacementMapElement#getXChannelSelector()}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link SVGFEDisplacementMapElement#getYChannelSelector()}.
	 */
	@Override
