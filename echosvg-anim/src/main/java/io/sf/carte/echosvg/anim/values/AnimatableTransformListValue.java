...
public class AnimatableTransformListValue extends AnimatableValue {
	 ...
	 */
	public AnimatableTransformListValue(AnimationTarget target, List<SVGTransform> transforms) {
		super(target);
	...
	/**
	 * Performs a two-way interpolation between the specified values. value[12] and
	 * to[12] must all be of the same type, either scale or translation transforms,
	 * or all null.
	 */
	public static AnimatableTransformListValue interpolate(AnimatableTransformListValue res,
			AnimatableTransformListValue value1, AnimatableTransformListValue value2, AnimatableTransformListValue to1,
			AnimatableTransformListValue to2, float interpolation1, float interpolation2,
			AnimatableTransformListValue accumulation, int multiplier) {
	...
	/**
	 * Performs a three-way interpolation between the specified values. value[123]
	 * and to[123] must all be single rotation transforms, or all null.
	 */
	public static AnimatableTransformListValue interpolate(AnimatableTransformListValue res,
			AnimatableTransformListValue value1, AnimatableTransformListValue value2,
			AnimatableTransformListValue value3, AnimatableTransformListValue to1, AnimatableTransformListValue to2,
			AnimatableTransformListValue to3, float interpolation1, float interpolation2, float interpolation3,
			AnimatableTransformListValue accumulation, int multiplier) {
	...
	/**
	 * Returns the distance between this value's first component and the specified
	 * other value's first component.
	 */
	...
	/**
	 * Returns the distance between this value's second component and the specified
	 * other value's second component.
	 */
	...
	/**
	 * Returns the distance between this value's third component and the specified
	 * other value's third component.
	 */
	...
	/**
	 * Returns a zero value of this AnimatableValue's type. This returns an empty
	 * transform list.
	 */
	@Override
