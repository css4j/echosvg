...
public class SVGOMFEMorphologyElement extends SVGOMFilterPrimitiveStandardAttributes implements SVGFEMorphologyElement {
	...
	static {
		...
		t.put(null, SVG_RADIUS_ATTRIBUTE, new TraitInformation(true, SVGTypes.TYPE_NUMBER_OPTIONAL_NUMBER));
	 ...
	 */
	protected static final String[] OPERATOR_VALUES = { "", SVG_ERODE_VALUE, SVG_DILATE_VALUE };
	...
	public SVGAnimatedNumber getRadiusX() {
		throw new UnsupportedOperationException("SVGFEMorphologyElement.getRadiusX is not implemented"); // XXX
	}
	...
	public SVGAnimatedNumber getRadiusY() {
		throw new UnsupportedOperationException("SVGFEMorphologyElement.getRadiusY is not implemented"); // XXX
	}
