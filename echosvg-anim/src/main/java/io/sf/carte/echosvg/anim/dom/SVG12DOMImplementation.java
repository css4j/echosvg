...
public class SVG12DOMImplementation extends SVGDOMImplementation {
	...
	static {
		...
		xblFactories.put(XBLConstants.XBL_TEMPLATE_TAG, new XBLTemplateElementFactory());
		...
		xblFactories.put(XBLConstants.XBL_IMPORT_TAG, new XBLImportElementFactory());
	 ...
	 */
	protected static final DOMImplementation DOM_IMPLEMENTATION = new SVG12DOMImplementation();
