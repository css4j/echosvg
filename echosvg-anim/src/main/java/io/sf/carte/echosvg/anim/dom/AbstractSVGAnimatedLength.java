...
/**
 * This class provides an implementation of the {@link SVGAnimatedLength}
 * interface.
 *
...
public abstract class AbstractSVGAnimatedLength extends AbstractSVGAnimatedValue
	...
	/**
	 * @return the default value to use when the associated attribute was not
	 *         specified.
	 */
	...
	public float getCheckedValue() {
		if (hasAnimVal) {
			...
			if (nonNegative && animVal.value < 0) {
				throw new LiveAttributeException(element, localName, LiveAttributeException.ERR_ATTRIBUTE_NEGATIVE,
	...
	protected void updateAnimatedValue(AnimatableValue val) {
		if (val == null) {
			...
			animVal.setAnimatedValue(animLength.getLengthType(), animLength.getLengthValue());
		}
	 ...
	 * {@link AbstractSVGAnimatedLength#getBaseVal() }.
	 */
	protected class BaseSVGLength extends AbstractSVGLength {
		 ...
		 * 
		 * @param direction is one of HORIZONTAL_LENGTH, VERTICAL_LENGTH, or
		 *                  OTHER_LENGTH
		 */
	...
	/**
	 * This class represents the SVGLength returned by
	 * {@link AbstractSVGAnimatedLength#getAnimVal()}.
	 */
