...
public class SVGOMTextPathElement extends SVGOMTextContentElement implements SVGTextPathElement {
	 ...
	 */
	protected static final String[] METHOD_VALUES = { "", SVG_ALIGN_VALUE, SVG_STRETCH_VALUE };

	/**
	 * The 'spacing' attribute values.
	 */
	protected static final String[] SPACING_VALUES = { "", SVG_AUTO_VALUE, SVG_EXACT_VALUE };
