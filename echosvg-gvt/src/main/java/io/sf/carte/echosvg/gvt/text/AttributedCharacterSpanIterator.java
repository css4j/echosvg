 ...
 *
 * Used to provide ACI functionality to a "substring" of an AttributedString. In
 * this way a TextLayout can be created which only uses a substring of
 * AttributedString.
 *
...
public class AttributedCharacterSpanIterator implements AttributedCharacterIterator {
	...
	/**
	 * Construct a AttributedCharacterSpanIterator from a subinterval of an existing
	...
	@Override
	public Object clone() {
		return new AttributedCharacterSpanIterator((AttributedCharacterIterator) aci.clone(), begin, end);
	}
