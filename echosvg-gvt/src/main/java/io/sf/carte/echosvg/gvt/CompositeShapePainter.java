...
public class CompositeShapePainter implements ShapePainter {
	 ...
	 */
	/*
	 * public void setShapePainter(int index, ShapePainter shapePainter) { if
	 * (shapePainter == null) { return; } if (this.shape != shapePainter.getShape())
	 * { shapePainter.setShape(shape); } if (painters == null || index >=
	 * painters.length) { throw new IllegalArgumentException("Bad index: "+index); }
