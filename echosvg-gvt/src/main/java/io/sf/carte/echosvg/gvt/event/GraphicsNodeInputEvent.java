...
public abstract class GraphicsNodeInputEvent extends GraphicsNodeEvent {
	...
	/**
	 * The graphics node input events Time stamp. The time stamp is in UTC format
	 * that indicates when the input event was created.
	 */
	long when;

	/**
	 * The state of the modifier keys at the time the graphics node input event was
	 * fired.
	 */
	int modifiers;

	/**
	 * The state of the key locks at the time the graphics node input event was
	 * fired.
	 */
	int lockState;
