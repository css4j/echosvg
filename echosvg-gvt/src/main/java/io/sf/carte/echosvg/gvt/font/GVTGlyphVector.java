...
public interface GVTGlyphVector {
	 ...
	 * This is a good bound for hit detection and highlighting it is not tight in
	 * any sense, and in some (rare) cases may exclude parts of the glyph.
	 */
	...
	/**
	 * Returns the logical bounds of this GlyphVector. This is a good bound for hit
	 * detection and highlighting it is not tight in any sense, and in some (rare)
