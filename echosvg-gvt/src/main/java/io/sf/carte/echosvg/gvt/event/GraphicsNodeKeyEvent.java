...
public class GraphicsNodeKeyEvent extends GraphicsNodeInputEvent {
	...
	/**
	 * <code>keyChar</code> is a valid unicode character that is fired by a key or a
	 ...
	 */
	public GraphicsNodeKeyEvent(GraphicsNode source, int id, long when, int modifiers, int lockState, int keyCode,
