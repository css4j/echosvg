...
/**
 * An abstract adapter class for receiving graphics node mouse events. The
 * methods in this class are empty. This class exists as convenience for
 * creating listener objects.
 *
 * <p>
 * Extend this class to create a <code>GraphicsNodeMouseEvent</code> listener
 * and override the methods for the events of interest. (If you implement the
 * <code>GraphicsNodeMouseListener</code> interface, you have to define all of
