...
public class GVTLineMetrics {
	 ...
	 *
	 * @param lineMetrics The lineMetrics object that this metrics object will be
	 *                    based upon.
	 */
	...
	/**
	 * Constructs a GVTLineMetrics object based on the specified line metrics with a
	 ...
	 */
	public GVTLineMetrics(float ascent, int baselineIndex, float[] baselineOffsets, float descent, float height,
			float leading, int numChars, float strikethroughOffset, float strikethroughThickness, float underlineOffset,
			float underlineThickness, float overlineOffset, float overlineThickness) {
	...
	/**
	 * Returns the number of characters in the text whose metrics are encapsulated
	 * by this LineMetrics object.
	 */
