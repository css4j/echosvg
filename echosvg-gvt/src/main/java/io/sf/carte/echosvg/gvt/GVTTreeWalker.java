...
/**
 * <code>GVTTreeWalker</code> objects are used to navigate a GVT tree or
 * subtree.
 *
...
public class GVTTreeWalker {
	...
	/**
	 * Returns the previous <code>GraphicsNode</code>. If the current graphics node
	...
	/**
	 * Returns the next <code>GraphicsNode</code>. If the current graphics node does
	...
	/**
	 * Returns the parent of the current <code>GraphicsNode</code>. If the current
	...
	/**
	 * Returns the next sibling of the current <code>GraphicsNode</code>. If the
	 * current graphics node does not have a next sibling, returns null and retains
	 * the current node.
	 */
	...
	/**
	 * Returns the next previous of the current <code>GraphicsNode</code>. If the
	...
	/**
	 * Returns the first child of the current <code>GraphicsNode</code>. If the
	 * current graphics node does not have a first child, returns null and retains
	 * the current node.
	 */
	...
	/**
	 * Returns the last child of the current <code>GraphicsNode</code>. If the
	 * current graphics node does not have a last child, returns null and retains
	 * the current node.
	 */
