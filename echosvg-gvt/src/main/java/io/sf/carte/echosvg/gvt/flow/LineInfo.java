...
public class LineInfo {
	...
	/**
	 * This method updates the line height and recalculates the available flow
	 * ranges for the line.
	 */
	...
	/**
	 * This function merges the glyph groups from <code>wi</code> into the glyph
	 * groups that are already on this line. It does no fit checking, just adds them
	 * in the proper place in the <code>newGGIS</code> data member.
	 */
