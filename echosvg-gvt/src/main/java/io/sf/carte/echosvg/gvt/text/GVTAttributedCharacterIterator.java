...
public interface GVTAttributedCharacterIterator extends AttributedCharacterIterator {
	 ...
	 */
	void setAttributeArray(TextAttribute attr, Object[] attValues, int beginIndex, int endIndex);
	...
	/**
	 * Attribute keys that identify SVG text attributes. Anchor point for attribute
	 * values of X, Y, and ROTATION is determined by the character's font and other
	 * attributes. We duplicate the features of java.awt.font.TextAttribute rather
	 * than subclassing because java.awt.font.TextAttribute is <em>final</em>.
	 */
	class TextAttribute extends AttributedCharacterIterator.Attribute {
		 ...
		 * 
		 * @see io.sf.carte.echosvg.gvt.text.GVTAttributedCharacterIterator.TextAttribute#SMALL_CAPS
		 */
		...
		public static final TextAttribute HORIZONTAL_ORIENTATION_ANGLE = new TextAttribute(
		...
		public static final Integer ADJUST_SPACING = 0x0;

		/** Value for LENGTH_ADJUST specifying overall scaling of layout outlines */
		public static final Integer ADJUST_ALL = 0x01;
	 ...
	 * AttributedCharacterIterator. Typically used to convert location and rotation
	 * attributes to TextAttribute.TRANSFORM attributes, or convert between
	 * implementations of AttributedCharacterIterator.Attribute.
	 */
	interface AttributeFilter {

		/**
		 * Modify an AttributedCharacterIterator's attributes systematically. Usually
		 * returns a copy since AttributedCharacterIterator instances are often
		 * immutable. The effect of the attribute modification is implementation
		 * dependent.
		 * 
		 * @param aci an AttributedCharacterIterator whose attributes are to be
		 *            modified.
		 * @return an instance of AttributedCharacterIterator with mutated attributes.
		 */
