...
public class CanvasGraphicsNode extends CompositeGraphicsNode {
	...
	/**
	 * This is the position transform for this graphics node. This is needed because
	 * getCTM returns the transform to the viewport coordinate system which is after
	 * viewing but before positioning.
	 */
	protected AffineTransform positionTransform;
	/**
	 * This is the viewing transform for this graphics node. This is needed because
	 * getCTM returns the transform to the viewport coordinate system which is after
	 * viewing but before positioning.
	 */
