...
/**
 * The base class for all graphics nodes. A GraphicsNode encapsulates graphical
 * attributes and can perform atomic operations of a complex rendering.
 *
...
public interface GraphicsNode {
	...
	/**
	 * Indicates that this graphics node can be the target for events when it is
	 * visible and when the mouse is over the "painted" area.
	 */
	int VISIBLE_PAINTED = 0;

	/**
	 * Indicates that this graphics node can be the target for events when it is
	 * visible and when the mouse is over the filled area if any.
	 */
	int VISIBLE_FILL = 1;

	/**
	 * Indicates that this graphics node can be the target for events when it is
	 * visible and when the mouse is over the stroked area if any.
	 */
	int VISIBLE_STROKE = 2;

	/**
	 * Indicates that this graphics node can be the target for events when it is
	 * visible and whatever is the filled and stroked area.
	 */
	int VISIBLE = 3;

	/**
	 * Indicates that this graphics node can be the target for events when the mouse
	 * is over the painted area whatever or not it is the visible.
	 */
	int PAINTED = 4;

	/**
	 * Indicates that this graphics node can be the target for events when the mouse
	 * is over the filled area whatever or not it is the visible.
	 */
	int FILL = 5;

	/**
	 * Indicates that this graphics node can be the target for events when the mouse
	 * is over the stroked area whatever or not it is the visible.
	 */
	int STROKE = 6;
	...
	/**
	 * Adds the specified graphics node key listener to receive graphics node key
