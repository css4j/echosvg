 ...
 * It provides a more convenient method of looking up kerning values when laying
 * out glyphs.
 *
...
public class KerningTable {
	 ...
	 *
	 * @param entries The array of Kern objects that represent the kerning entries
	 *                for the font that this kerning table belongs to.
	 */
	 ...
	 * Returns 0 if the glyphs should not be kerned.
	 *
