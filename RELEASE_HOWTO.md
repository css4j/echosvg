...
- Java 11 to 25, which you can install from your favourite package manager or
...
```shell
./gradlew copyJars
mv jar echosvg-2.5.1-bin
7z a -mx9 echosvg-2.5.1-binaries.zip echosvg-2.5.1-bin
```
...
mv modular echosvg-2.5.1-modular-javadocs
7z a echosvg-2.5.1-modular-javadocs.7z echosvg-2.5.1-modular-javadocs
7z a -mx9 echosvg-2.5.1-modular-javadocs.zip echosvg-2.5.1-modular-javadocs
```
...
```shell
cd /path/to/echosvg
git tag -s v2.5.1 -m "Release 2.5.1"
...
Add to the Github release the `echosvg-2.5.1-bin.zip` archive that you created,
the modular javadoc archives (`echosvg-2.5.1-modular-javadocs.7z` and
`echosvg-2.5.1-modular-javadocs.zip`), and the result of executing:

```shell
./gradlew uberjar
```
to be found at the `echosvg-all/build/libs/echosvg-all-2.5.1-alldeps.jar`. Then execute:
...
```
echosvg-codec/build/libs/echosvg-codec-2.5.1-with-deps.jar
echosvg-svggen/build/libs/echosvg-svggen-2.5.1-with-deps.jar
echosvg-transcoder/build/libs/echosvg-transcoder-2.5.1-with-deps.jar
echosvg-transcoder-svg/build/libs/echosvg-transcoder-svg-2.5.1-with-deps.jar
echosvg-transcoder-tosvg/build/libs/echosvg-transcoder-tosvg-2.5.1-with-deps.jar
echosvg-transcoder-svg2svg/build/libs/echosvg-transcoder-svg2svg-2.5.1-with-deps.jar
```
