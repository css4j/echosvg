...
public class JErrorPane extends JPanel implements ActionMap {
	 ...
	 */
	protected static final String RESOURCES = "io.sf.carte.echosvg.util.gui.resources.JErrorPane";
	...
	protected class ShowDetailButtonAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent evt) {
			if (isDetailShown) {
				...
				isDetailShown = false;
				showDetailButton.setText(resources.getString("ShowDetailButton.text"));
			} else {
				subpanel.add(detailsArea, BorderLayout.CENTER);
				showDetailButton.setText(resources.getString("ShowDetailButton.text2"));
				isDetailShown = true;
			}
