...
public class MemoryMonitor extends JFrame implements ActionMap {
	 ...
	 */
	protected static final String RESOURCE = "io.sf.carte.echosvg.util.gui.resources.MemoryMonitorMessages";
	...
	public static class Panel extends JPanel {
		...
		/**
		 * Creates a new memory monitor panel, composed of a Usage instance and a
		 * History instance. The time beetween two repaints is 1s.
		 */
		public Panel() {
			this(1000);
		}
		...
		/**
		 * Creates a new memory monitor panel, composed of a Usage instance and a
		 * History instance. The repaint thread must be started by hands.
		 * 
		 * @param time The time beetween two repaints in ms.
		 */
	...
	public static class Usage extends JPanel implements MemoryChangeListener {
		 ...
		 */
		protected Color[] usedColors = { Color.red, new Color(255, 165, 0), Color.green };
		...
		protected void paintComponent(Graphics g) {
			...
			for (int i = 0; i < nfree; i++) {
				Rectangle2D rect = new Rectangle2D.Double(10, i * BLOCK_HEIGHT + i + FONT_SIZE + 5, BLOCK_WIDTH,
						BLOCK_HEIGHT);
