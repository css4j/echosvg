...
public class CSSMediaPanel extends JPanel implements ActionMap {
	 ...
	 */
	public static int showDialog(Component parent, String title, List<String> mediaList) {
	...
	protected class AddButtonAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if ((dialog.getReturnCode() == AddMediumDialog.CANCEL_OPTION) || (dialog.getMedium() == null)) {
				return;
			}
	...
	public static class AddMediumDialog extends JDialog implements ActionMap {
		...
		public AddMediumDialog(Component parent) {
			super(JOptionPane.getFrameForComponent(parent), resources.getString("AddMediumDialog.title"));
			setModal(true);
		...
		protected Component createContentPanel() {
			...
			panel.add(new JLabel(resources.getString("AddMediumDialog.label")), BorderLayout.WEST);
