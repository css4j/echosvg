...
public class UserStyleDialog extends JDialog implements ActionMap {
	 ...
	 */
	protected static final String RESOURCES = "io.sf.carte.echosvg.util.gui.resources.UserStyleDialog";
	...
	protected class OKButtonAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if (panel.fileCheckBox.isSelected()) {
				...
				if (path.equals("")) {
					JOptionPane.showMessageDialog(UserStyleDialog.this, resources.getString("StyleDialogError.text"),
							resources.getString("StyleDialogError.title"), JOptionPane.ERROR_MESSAGE);
					return;
				} else {
	...
	public static class Panel extends JPanel {
		...
		public Panel() {
			...
			fileCheckBox = new JCheckBox(resources.getString("PanelFileCheckBox.text"));
