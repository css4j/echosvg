...
public class ToolBarFactory extends ResourceManager {
	 ...
	 * @throws MissingResourceException if one of the keys that compose the tool bar
	 *                                  is missing. It is not thrown if the action
	 *                                  key is missing.
	 ...
	 * @throws MissingResourceException if key is not the name of a button. It is
	 *                                  not thrown if the mnemonic and the action
	 *                                  keys are missing
	 * @throws ResourceFormatException  if the mnemonic is not a single character
	 * @throws MissingListenerException if the button action is not found in the
	 *                                  action map.
	 */
