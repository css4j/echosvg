 ...
 *
 * @deprecated jan '07 : this class is not used anywhere in EchoSVG, it might be
 *             removed in the future. Probably WMFRecordStore is what you need.
 *
...
public class RecordStore {
	...
	/**
	 * Reads the Wmf file from the specified Stream. A Wmf file can be produced
	 * using the GConvert utility found at http://www.asd.ie/Wmf.htm
	 *
	 * The Wmf format is slightly more compact than the original WMF format and in
	 * some cases may produce better handling of colours.
	 */
	...
	/**
	 * Adds a GdiObject to the internal handle table. Adds the object at the next
	 * free location.
	 *
