...
public class TranscoderOutput {
	...
	/**
	 * Constructs a new <code>TranscoderOutput</code> with the specified XML filter.
	 * 
	...
	/**
	 * Constructs a new <code>TranscoderOutput</code> with the specified byte stream
	 * output.
	 * 
	...
	/**
	 * Constructs a new <code>TranscoderOutput</code> with the specified character
	 * stream.
	 * 
	...
	/**
	 * Returns the output of this transcoder as a XML filter or null if none was
	 * supplied.
	 */
	...
	/**
	 * Returns the output of this transcoder as a byte stream or null if none was
	 * supplied.
	 */
	...
	/**
	 * Sets the output of this transcoder output with the specified character
	 * stream.
	 * 
	 * @param writer the character stream of this transcoder output
	 */
	...
	/**
	 * Returns the output of this transcoder as a character stream or null if none
	 * was supplied.
	 */
	...
	/**
	 * Returns the output of this transcoder as a document or null if none was
	 * supplied.
	 */
