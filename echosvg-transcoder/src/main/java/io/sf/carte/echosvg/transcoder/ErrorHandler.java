 ...
 * implement this interface and then register an instance with the Transcoder
 * using the transcoder's setErrorHandler method. The transcoder will then
 * report all errors and warnings through this interface.
 *
 * A transcoder shall use this interface instead of throwing an exception: it is
 ...
 * transcoder continue to provide useful information after a call to fatalError
 * (in other words, a transcoder class could catch an exception and report a
 * fatalError).
 *
