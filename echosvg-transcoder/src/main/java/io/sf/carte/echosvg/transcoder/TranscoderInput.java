...
public class TranscoderInput {
	...
	/**
	 * Constructs a new <code>TranscoderInput</code> with the specified XML reader.
	 * 
	...
	/**
	 * Constructs a new <code>TranscoderInput</code> with the specified byte stream
	 * input.
	 * 
	...
	/**
	 * Constructs a new <code>TranscoderInput</code> with the specified character
	 * stream.
	 * 
	...
	/**
	 * Returns the input of this transcoder as a byte stream or null if none was
	 * supplied.
	 */
	...
	/**
	 * Returns the input of this transcoder as a character stream or null if none
	 * was supplied.
	 */
	...
	/**
	 * Returns the input of this transcoder as a document or null if none was
	 * supplied.
	 */
