...
public abstract class ImageDecoderImpl implements ImageDecoder {
	 ...
	 * <code>ImageDecoder</code> may throw a <code>RuntimeException</code> if the
	 * <code>param</code> argument is not an instance of the appropriate subclass or
	 * subinterface. For example, a <code>JPEGImageDecoder</code> will expect
	 * <code>param</code> to be an instance of <code>JPEGDecodeParam</code>.
	 */
	@Override
	...
	/**
	 * Returns the number of pages present in the current stream. By default, the
	 * return value is 1. Subclasses that deal with multi-page formats should
	 ...
	 * <code>SeekableStream</code> associated with this <code>ImageDecoder</code>.
	 * Only the first page of a multi-page image is decoded.
	 */
	@Override
	 ...
	 * Returns a <code>Raster</code> that contains the decoded contents of the
	 * <code>SeekableStream</code> associated with this <code>ImageDecoder</code>.
	 * The given page of a multi-page image is decoded. If the page does not exist,
