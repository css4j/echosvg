...
public abstract class SimpleRenderedImage implements RenderedImage {
	 ...
	 * not recognized, <code>null</code> will be returned.
	 *
	 ...
	 * are available, an empty String[] will be returned.
	 *
...
//        }
	...
	/**
	 * Returns an array of <code>String</code>s recognized as names by this property
	 * source that begin with the supplied prefix. If no property names match,
	 * <code>null</code> will be returned. The comparison is done in a
	 ...
	 *
	 * @return an array of <code>String</code>s giving the valid property names (can
	 *         be null).
	 */
