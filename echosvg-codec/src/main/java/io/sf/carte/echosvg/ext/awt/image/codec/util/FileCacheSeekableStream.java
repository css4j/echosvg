 ...
 * <code>InputStream</code>. Seeking backwards is supported by means of a file
...
public final class FileCacheSeekableStream extends SeekableStream {
	 ...
	 * data from a regular <code>InputStream</code>. Seeking backwards is supported
	 * by means of an file cache.
	 *
	 * <p>
	 * An <code>IOException</code> will be thrown if the attempt to create the cache
	 ...
	 * source is reached. The return value is equal to the smaller of
	...
	/**
	 * Returns <code>true</code> since all <code>FileCacheSeekableStream</code>
