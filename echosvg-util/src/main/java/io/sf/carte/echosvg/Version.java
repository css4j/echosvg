 ...
 */
package io.sf.carte.echosvg;

/**
 * This class defines the EchoSVG version number.
 *
...
public final class Version {
    ...
    public static String getVersion() {
        ...
        String headURL = "$HeadURL: https://svn.apache.org/repos/asf/xmlgraphics/batik/branches/maven/batik-util" +
                "/src/main/java/io/sf/carte/echosvg/Version.java $";
        String prefix = "$HeadURL: ";
        String suffix = "/sources/io/sf/carte/echosvg/Version.java $";
