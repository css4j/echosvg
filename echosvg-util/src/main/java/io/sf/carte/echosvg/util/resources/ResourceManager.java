...
public class ResourceManager {
	 ...
	 * @throws MissingResourceException if key is not the name of a resource
	 */
	public List<String> getStringList(String key) throws MissingResourceException {
	 ...
	 * @throws MissingResourceException if key is not the name of a resource
	 */
	public List<String> getStringList(String key, String delim) throws MissingResourceException {
	 ...
	 * @throws MissingResourceException if key is not the name of a resource
	 */
	public List<String> getStringList(String key, String delim, boolean returnDelims) throws MissingResourceException {
	...
	public int getInteger(String key) throws MissingResourceException, ResourceFormatException {
		...
		try {
			...
			throw new ResourceFormatException("Malformed integer", bundle.getClass().getName(), key);
		}
	}
