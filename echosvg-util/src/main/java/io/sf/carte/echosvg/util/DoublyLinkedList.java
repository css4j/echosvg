...
public class DoublyLinkedList {
	...
	/**
	 * Moves <code>nde</code> to the head of the list (equivilent to remove(nde);
	 * add(nde); but faster.
	 */
	...
	/**
	 * Adds <code>nde</code> to the head of the list. In perl this is called an
	 * 'unpop'. <code>nde</code> should not currently be part of any list.
	 * 
	...
	/**
	 * Removes nde from the list it is part of (should be this one, otherwise
	 * results are undefined). If nde is the current head element, then the next
	 * element becomes head, if there are no more elements the list becomes empty.
	 * 
