 ...
 * 'file' 'http' 'ftp'. The parsing should be general enought to support most
...
public class ParsedURLDefaultProtocolHandler extends AbstractParsedURLProtocolHandler {
	...
	/**
	 * Subclasses can override these method to construct alternate subclasses of
	 * ParsedURLData.
	 */
	...
	/**
	 * Parses the string and returns the results of parsing in the ParsedURLData
	 * object.
	 * 
	...
	public ParsedURLData parseURL(String urlStr) {
		...
		if ((idx == -1) || ((pidx + 2 < len) && (urlStr.charAt(pidx) == '/') && (urlStr.charAt(pidx + 1) == '/'))) {
			...
			if (((ret.host == null) || (ret.host.indexOf('.') == -1)) && (ret.port == -1))
	...
	/**
	 * Parses the string as a sub URL of baseURL, and returns the results of parsing
	 * in the ParsedURLData object.
	 * 
