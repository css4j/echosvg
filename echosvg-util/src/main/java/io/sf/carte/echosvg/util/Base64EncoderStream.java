...
public class Base64EncoderStream extends OutputStream {
	...
	/**
	 * This can't really flush out output since that may generate '=' chars which
	 * would indicate the end of the stream. Instead we flush out. You can only be
	 * sure all output is writen by closing this stream.
	 */
	@Override
