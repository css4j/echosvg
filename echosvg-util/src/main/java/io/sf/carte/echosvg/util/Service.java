 ...
 *
 * <a href=
 * "http://java.sun.com/j2se/1.3/docs/guide/jar/jar.html#Service%20Provider">JAR
 * File Specification Under Service Provider</a>. Note that this interface is
 * very similar to the one they describe which seems to be missing in the JDK.
 *
...
public class Service {
	 ...
	 * subclass the baseclass) described by cls. The Classes are found by searching
	 * the classpath for service files named: 'META-INF/services/&lt;fully qualified
	 * classname&gt; that list fully qualifted classnames of classes that implement
	 * the service files classes interface. These classes must have default
	 * constructors.
	 *
