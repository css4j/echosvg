 ...
 * LocalizableSupport object in the current LocaleGroup, use this Locale, else,
 * </li>
 * <li>use the object returned by Locale.getDefault() (and set by
 * Locale.setDefault()).</li>
 * </ul>
...
public class LocalizableSupport implements Localizable {
	 ...
	 * @param cl is the classloader used to create the resource bundle, or null.
	...
	/**
	 * Implements
	 * {@link io.sf.carte.echosvg.i18n.ExtendedLocalizable#setLocaleGroup(LocaleGroup)}.
	 */
	...
	/**
	 * Implements
	 * {@link io.sf.carte.echosvg.i18n.ExtendedLocalizable#getLocaleGroup()}.
	 */
	...
	/**
	 * Implements
	 * {@link io.sf.carte.echosvg.i18n.ExtendedLocalizable#setDefaultLocale(Locale)}.
	...
	/**
	 * Implements
	 * {@link io.sf.carte.echosvg.i18n.ExtendedLocalizable#getDefaultLocale()}.
	 */
	...
	/**
	 * returns true if the locale is different from the previously used locale. Also
	 * sets 'usedLocale' to the current locale.
	 */
	...
	public int getInteger(String key) throws MissingResourceException {
		...
		try {
			...
			throw new MissingResourceException("Malformed integer", bundleName, key);
		}
	}
