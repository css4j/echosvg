 ...
 * @see io.sf.carte.echosvg.svggen.DOMGroupManager
...
public class SVGGraphics2D extends AbstractGraphics2D implements Cloneable, SVGSyntax, ErrorConstants {
	...
	/**
	 * @param extensionHandler new extension handler this SVGGraphics2D should use
	 */
	...
	/**
	 * @param domFactory Factory which will produce Elements for the DOM tree this
	 ...
	 * @param imageHandler     defines how images are referenced in the generated
	 *                         SVG fragment
	...
	public static SVGGeneratorContext buildSVGGeneratorContext(Document domFactory, ImageHandler imageHandler,
		...
		generatorCtx.setComment("Generated by the EchoSVG Graphics2D SVG Generator");
	 ...
	 * 
	 * @param generatorCtx the <code>SVGGeneratorContext</code> instance that will
	 *                     provide all useful information to the generator.
	 * @param textAsShapes if true, all text is turned into SVG shapes in the
	 *                     convertion. No SVG text is output.
	 *
	 ...
	 * @param escaped defines if the characters will be escaped style properties as
	 ...
	 * @param writer  output
	 * @param useCss  defines whether the output SVG should use CSS style
	 * @param escaped defines if the characters will be escaped properties as
	 *                opposed to plain attributes.
	 */
	 ...
	 */
	public java.util.List<Element> getDefinitionSet() {
	 ...
	 * attributes.
	 *
	 * @param svgRoot an SVG element underwhich the content should be appended.
	 * @return the svg root node of the SVG document associated with this object.
	 */
	 ...
	 * @param x   the x coordinate in user space where the upper left corner of the
	 *            image is rendered
	 * @param y   the y coordinate in user space where the upper left corner of the
	 *            image is rendered
	 * @see #setTransform(AffineTransform)
	 * @see #setComposite(java.awt.Composite)
	 * @see #setClip(Shape)
	 ...
	 */
	protected Set<Attribute> unsupportedAttributes;
	{
	 ...
	 *
	 * @param attrs The set of attrs to treat as unsupported, and if present cause
	 *              text to be drawn as paths. If null ACI text will be rendered as
	 *              text (unless 'textAsShapes' is set).
	 */
	public void setUnsupportedAttributes(Set<Attribute> attrs) {
		if (attrs == null)
	...
	public boolean usesUnsupportedAttributes(AttributedCharacterIterator aci) {
		...
		Set<Attribute> allAttrs = aci.getAllAttributeKeys();
		for (Attribute allAttr : allAttrs) {
