 ...
 * convertion operations. It holds a reference to a domFactory Document, which
 * many implementations use, and provides a convenience method, to offers a
 * convertion of double values to String that remove the trailing '.' character
 * on integral values.
 *
...
public abstract class AbstractSVGFilterConverter implements SVGFilterConverter, ErrorConstants {
	...
	/**
	 * Map of descriptions already processed by this converter. The key type is left
	 * to the implementations
	 */
	protected Map<BufferedImageOp, SVGFilterDescriptor> descMap = new HashMap<>();

	/**
	 * Set of definitions to interpret the values of the attributes generated by
	 * this converter since its creation
	 */
	protected List<Element> defSet = new LinkedList<>();

	/**
	 * @param generatorContext an be used by the SVGConverter extentions to create
	 *                         Elements and other types of DOM objects.
	 */
