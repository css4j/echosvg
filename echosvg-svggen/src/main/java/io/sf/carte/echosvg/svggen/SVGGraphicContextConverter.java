 ...
 * graphic context into a set of graphic attributes. It also manages a set of
 * SVG definitions referenced by the SVG attributes.
 *
...
public class SVGGraphicContextConverter {
	...
	/**
	 * @param generatorContext the context that will be used to create elements,
	 *                         handle extension and images.
	 */
	...
	/**
	 * @return a String containing the transform attribute value equivalent of the
	 *         input transform stack.
	 */
	...
	/**
	 * @return an object that describes the set of SVG attributes that represent the
	 *         equivalent of the input GraphicContext state.
	 */
	...
	/**
	 * @return a set of element containing definitions for the attribute values
