...
import io.sf.carte.echosvg.ext.awt.g2d.TransformType;
...
public class SVGTransform extends AbstractSVGConverter {
	...
	/**
	 * @param gc GraphicContext whose transform stack should be converted to SVG.
	...
	/**
	 * This method tries to collapse the transform stack into an SVG string as
	 * compact as possible while still conveying the semantic of the stack.
	 * Successive stack elements of the same kind (e.g., two successive transforms
	 * or scales) are collapsed into a single element.
	 *
	 * @param transformStack sequence of transform that should be converted to an
	 *                       SVG transform attribute equivalent
	 */
