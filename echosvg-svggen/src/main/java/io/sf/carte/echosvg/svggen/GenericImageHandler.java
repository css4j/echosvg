...
public interface GenericImageHandler {
	...
	/**
	 * Creates an Element suitable for referring to images. Note that no assumptions
	 * can be made about the name of this Element.
	 */
	 ...
	 */
	AffineTransform handleImage(Image image, Element imageElement, int x, int y, int width, int height,
	 ...
	 * @return transform converting the image dimension to rendered dimension
	 */
	AffineTransform handleImage(RenderedImage image, Element imageElement, int x, int y, int width, int height,
			SVGGeneratorContext generatorContext);
	 ...
	 * @return transform converting the image dimension to rendered dimension
	 */
	AffineTransform handleImage(RenderableImage image, Element imageElement, double x, double y, double width,
