...
public class DOMTreeManager implements SVGSyntax, ErrorConstants {
     ...
     */
    protected final List<DOMGroupManager> groupManagers = Collections.synchronizedList( new ArrayList<DOMGroupManager>() );
    ...
    public Element getTopLevelGroup(boolean includeDefinitionSet){
        ...
        if(includeDefinitionSet){
            ...
            if(defSet.size() > 0){
                ...
                for (Element aDefSet : defSet) defElement.appendChild(aDefSet);
            }
        }
