 ...
 * properties and definitions. Here is how AlphaComposites are mapped to SVG: +
 ...
 * One of the big differences between AlphaComposite and the SVG feComposite
 * filter is that feComposite does not have the notion of extra alpha applied to
 * the source. The extra alpha equivalent is obtained by setting the opacity
 * property on the nodes to be composited.
 *
...
public class SVGAlphaComposite extends AbstractSVGConverter {
	...
	/**
	 * @return true if background access is required for any of the converted
	 *         AlphaComposite rules
	 */
	 ...
	 * @return an SVGCompositeDescriptor that defines how to map the input composite
	 *         in SVG
	 */
	 ...
	 * @exception Error if an AlphaComposite with SRC_OVER rule in passed to this
	 *                  method.
	 */
