...
public class SVGPolygon extends SVGGraphicObjectConverter {
	...
	public Element toSVG(Polygon polygon) {
		Element svgPolygon = getGeneratorContext().getDOMFactory().createElementNS(SVG_NAMESPACE_URI, SVG_POLYGON_TAG);
		...
		svgPolygon.setAttributeNS(null, SVG_POINTS_ATTRIBUTE, points.substring(0, points.length() - 1));
