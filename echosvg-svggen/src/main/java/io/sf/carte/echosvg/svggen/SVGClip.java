...
public class SVGClip extends AbstractSVGConverter {
	 ...
	 */
	public static final SVGClipDescriptor NO_CLIP = new SVGClipDescriptor(SVG_NONE_VALUE, null);
...
/**
 * Inner class used to key clip definitions in a Map. This is needed because we
 * need to test equality on the value of GeneralPath and GeneralPath's equal
