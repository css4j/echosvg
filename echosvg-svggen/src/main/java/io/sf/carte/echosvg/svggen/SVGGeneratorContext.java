 ...
 * are needed by the {@link io.sf.carte.echosvg.svggen.SVGGraphics2D} to
...
public class SVGGeneratorContext implements ErrorConstants {
    ...
    /**
     * Returns the {@link io.sf.carte.echosvg.svggen.SVGIDGenerator} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link io.sf.carte.echosvg.svggen.SVGIDGenerator}
    ...
    /**
     * Returns the {@link io.sf.carte.echosvg.svggen.ExtensionHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link io.sf.carte.echosvg.svggen.ExtensionHandler}
     * to be used. It should not be <code>null</code>.
     */
    ...
    /**
     * Returns the {@link io.sf.carte.echosvg.svggen.ImageHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link io.sf.carte.echosvg.svggen.ImageHandler}
     * to be used. It should not be <code>null</code>.
     */
    ...
    /**
     * Sets the {@link io.sf.carte.echosvg.svggen.GenericImageHandler}
     * to be used.
     */
    ...
    /**
     * Returns the {@link io.sf.carte.echosvg.svggen.StyleHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link io.sf.carte.echosvg.svggen.StyleHandler}
     * to be used. It should not be <code>null</code>.
     */
    ...
    /**
     * Returns the {@link io.sf.carte.echosvg.svggen.ErrorHandler} that
     * has been set.
     */
    ...
    /**
     * Sets the {@link io.sf.carte.echosvg.svggen.ErrorHandler}
     * to be used. It should not be <code>null</code>.
     */
