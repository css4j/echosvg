 ...
 * by the {@link io.sf.carte.echosvg.svggen.SVGGraphics2D} to generate SVG from
...
public class SVGGeneratorContext implements ErrorConstants {
	 ...
	 * @see io.sf.carte.echosvg.svggen.ImageHandlerBase64Encoder
	 ...
	 * information.
	 * 
	 * @see io.sf.carte.echosvg.svggen.SVGIDGenerator
	 * @see io.sf.carte.echosvg.svggen.DefaultExtensionHandler
	 * @see io.sf.carte.echosvg.svggen.ImageHandlerBase64Encoder
	 * @see io.sf.carte.echosvg.svggen.DefaultStyleHandler
	 * @see io.sf.carte.echosvg.svggen.DefaultErrorHandler
	 */
	...
	/**
	 * Returns the {@link io.sf.carte.echosvg.svggen.SVGIDGenerator} that has been
	 * set.
	 */
	...
	/**
	 * Sets the {@link io.sf.carte.echosvg.svggen.SVGIDGenerator} to be used. It
	...
	/**
	 * Returns the {@link io.sf.carte.echosvg.svggen.ExtensionHandler} that has been
	 * set.
	 */
	...
	/**
	 * Sets the {@link io.sf.carte.echosvg.svggen.ExtensionHandler} to be used. It
	 * should not be <code>null</code>.
	 */
	...
	/**
	 * Returns the {@link io.sf.carte.echosvg.svggen.ImageHandler} that has been
	 * set.
	 */
	...
	/**
	 * Sets the {@link io.sf.carte.echosvg.svggen.ImageHandler} to be used. It
	 * should not be <code>null</code>.
	 */
	...
	/**
	 * Sets the {@link io.sf.carte.echosvg.svggen.GenericImageHandler} to be used.
	 */
	...
	/**
	 * Returns the {@link io.sf.carte.echosvg.svggen.StyleHandler} that has been
	 * set.
	 */
	...
	/**
	 * Sets the {@link io.sf.carte.echosvg.svggen.StyleHandler} to be used. It
	 * should not be <code>null</code>.
	 */
	...
	/**
	 * Returns the {@link io.sf.carte.echosvg.svggen.ErrorHandler} that has been
	 * set.
	 */
	...
	/**
	 * Sets the {@link io.sf.carte.echosvg.svggen.ErrorHandler} to be used. It
	 * should not be <code>null</code>.
	 */
