...
/**
 * The <code>ErrorHandler</code> interface allows you to specialize how the
 * error will be set on an SVG <code>Element</code>.
 *
...
public class DefaultErrorHandler implements ErrorHandler {
	...
	/**
	 * This method handles the <code>SVGGraphics2DRuntimeException</code>. The
	 * default implementation print the exception message.
	 */
	@Override
