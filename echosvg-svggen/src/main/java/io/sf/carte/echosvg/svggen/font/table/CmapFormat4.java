...
public class CmapFormat4 extends CmapFormat {
	...
	public int mapCharCode(int charCode) {
		try {
			 ...
			 * 
			 * The original architecture of the Unicode Standard allowed for all encoded
			 * characters to be represented using sixteen bit code points. This allowed for
			 * up to 65,354 characters to be encoded. (Unicode code points U+FFFE and U+FFFF
			 * are reserved and unavailable to represent characters. For more details, see
			 * The Unicode Standard.)
			 * 
			 * My comment : Isn't there a typo here ? Shouldn't we rather read 65,534 ?
			 */
	...
	public String toString() {
		return new StringBuffer(80).append(super.toString()).append(", segCountX2: ").append(segCountX2)
				...
				.append(", idRangeOffset: ").append(intToStr(idRangeOffset)).toString();
	}

	/**
	 * local helper method to convert an int-array to String. Intended for
	 * debugging, format may change.
	 *
