 ...
 * The SVG filter corresponding to a LookupOp is an feComponentTransfer, with a
 * type set to 'table', the tableValues set to the content of the lookup table.
 *
...
public class SVGLookupOp extends AbstractSVGFilterConverter {
	 ...
	 * @return a description of the SVG filter corresponding to lookupOp. The
...
//            filterAttrBuf.append(URL_SUFFIX);
	...
	/**
	 * Converts the filter's LookupTable into an array of corresponding SVG table
	 * strings
	 */
