 ...
 * wrap those exceptions in a XMLException.
 *
...
public class XMLException extends RuntimeException {
	 ...
	 * become the default message for the XMLException.
	 * 
	 ...
	 *
	 * <p>
	 * If there is a embedded exception, and if the XMLException has no detail
	...
	/**
	 * Prints this <code>Exception</code> and its backtrace to the standard error
	 * stream.
	 */
	@Override
	...
	/**
	 * Prints this <code>Exception</code> and its backtrace to the specified print
	 * stream.
	 *
