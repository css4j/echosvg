...
public class SelfContainedSVGOnLoadTestValidator extends DefaultTestSuite {
	...
	public static final String processingErrorURL = "test-resources/io/sf/carte/echosvg/test/svg/processingError.svg";
	public static final String invalidTestResultElementsNumberURL = "test-resources/io/sf/carte/echosvg/test/svg/invalidTestResultElementsNumber.svg";
	public static final String unexpectedResultValueURL = "test-resources/io/sf/carte/echosvg/test/svg/unexpectedResultValue.svg";
	public static final String missingOrEmptyErrorCodeURL = "test-resources/io/sf/carte/echosvg/test/svg/missingOrEmptyErrorCode.svg";
	public static final String errorURL = "test-resources/io/sf/carte/echosvg/test/svg/error.svg";
	public static final String errorAndEntriesURL = "test-resources/io/sf/carte/echosvg/test/svg/errorAndEntries.svg";
	public static final String successURL = "test-resources/io/sf/carte/echosvg/test/svg/success.svg";
	...
	static class ReportErrorAndEntries extends DefaultErrorTest {
		public ReportErrorAndEntries() {
			super(errorAndEntriesURL, "can.you.read.this.error.code",
					new String[] { "can.you.read.this.first.entry", "can.you.read.this.second.entry" });
		}
	}
	...
	static class MissingOrEmptyErrorCode extends DefaultErrorTest {
		public MissingOrEmptyErrorCode() {
			super(missingOrEmptyErrorCodeURL,
					SelfContainedSVGOnLoadTest.ERROR_MISSING_OR_EMPTY_ERROR_CODE_ON_FAILED_TEST, null);
		}
	}

	static class UnexpectedResultValue extends DefaultErrorTest {
		public UnexpectedResultValue() {
			super(unexpectedResultValueURL, SelfContainedSVGOnLoadTest.ERROR_UNEXPECTED_RESULT_VALUE,
	...
	static class DefaultErrorTest extends AbstractTest {
		...
		public TestReport runImpl() throws Exception {
			SelfContainedSVGOnLoadTest t = new SelfContainedSVGOnLoadTest(svgURL);
			TestReport tr = t.run();
			...
			if (tr.getErrorCode() != expectedErrorCode) {
				...
				r.addDescriptionEntry(ENTRY_EXPECTED_ERROR_CODE, expectedErrorCode);
				return r;
			}
			...
			if (nDesc != enDesc) {
				...
				r.addDescriptionEntry(ENTRY_NUMBER_OF_DESCRIPTION, "" + nDesc);
				r.addDescriptionEntry(ENTRY_EXPECTED_NUMBER_OF_DESCRIPTION, "" + enDesc);
				return r;
			}
