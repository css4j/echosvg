...
public class SVGReferenceRenderingAccuracyTest extends ParametrizedRenderingAccuracyTest {
	 ...
	 *
	 * + First, the string is interpreted as a file description minus any url
	 * fragment it may have (stuff after a '#'). If the file's parent directory
	 * exists, then the file name is turned into a URL and the fragment if any is
	 * appended. + Otherwise, the string is supposed to be a URL. If it is an
	 * invalid URL, an IllegalArgumentException is thrown.
	 */
	@Override
