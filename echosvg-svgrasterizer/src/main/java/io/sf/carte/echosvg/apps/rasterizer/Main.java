 ...
 *
 * Each command line option is handled by an <code>OptionHandler</code> which is
 * responsible for converting the option into a configuration of the
...
public class Main implements SVGConverterController {
	...
	public interface OptionHandler {
		 ...
		 *
		 * Should throw an IllegalArgumentException if optionValue is not an acceptable
		 * option.
		 */
		void handleOption(String[] optionValues, SVGConverter c);

		/**
		 * Returns the number of values which the option handler requires. This defines
		 * the length of the optionValues array passed to the handler in the
		 * handleOption method
		 */
	 ...
	 * optionValues. If the size matches, the <code>safeHandleOption</code> method
	 * is invoked. Subclasses can implement the <code>safeHandleOption</code> method
	 ...
	 * means something in itself. Subclasses should implement the
	 * <code>handleOption</code> method which takes only an
	...
	/**
	 * Base class for options with a single option value. Subclasses should provide
	 * an implementation for the <code>handleOption</code> method which takes a
	 ...
	 * Subclasses should implement the <code>handleOption</code> method which takes
	 ...
	 * value. Subclasses should implement the <code>handleOption</code> method which
		...
		public Rectangle2D.Float parseRect(String rectValue) {
			...
			if (rectValue != null) {
				...
				if (st.countTokens() == 4) {
					...
					if (!Float.isNaN(x) && !Float.isNaN(y) && (!Float.isNaN(w) && w > 0)
							&& (!Float.isNaN(h) && h > 0)) {
	...
	public abstract static class ColorOptionHandler extends SingleValueOptionHandler {
		...
		/**
		 * Parse the input value, which should be in the following format: a.r.g.b where
		 * a, r, g and b are integer values, in decimal notation, between 0 and 255.
		 * 
	...
	public static String CL_OPTION_OUTPUT_DESCRIPTION = Messages.get("Main.cl.option.output.description",
			"No description");
	...
	public static String CL_OPTION_MIME_TYPE_DESCRIPTION = Messages.get("Main.cl.option.mime.type.description",
			"No description");
	...
	public static String CL_OPTION_WIDTH_DESCRIPTION = Messages.get("Main.cl.option.width.description",
			"No description");
	...
	public static String CL_OPTION_HEIGHT_DESCRIPTION = Messages.get("Main.cl.option.height.description",
			"No description");
	...
	public static String CL_OPTION_MAX_WIDTH_DESCRIPTION = Messages.get("Main.cl.option.max.width.description",
			"No description");
	...
	public static String CL_OPTION_MAX_HEIGHT_DESCRIPTION = Messages.get("Main.cl.option.max.height.description",
			"No description");
	...
	public static String CL_OPTION_BACKGROUND_COLOR_DESCRIPTION = Messages
			.get("Main.cl.option.background.color.description", "No description");
	...
	public static String CL_OPTION_MEDIA_TYPE_DESCRIPTION = Messages.get("Main.cl.option.media.type.description",
			"No description");

	/**
	 * Option to specify the default value for the font-family CSS property when
	 * converting the SVG image
	 */
	public static String CL_OPTION_DEFAULT_FONT_FAMILY = Messages.get("Main.cl.option.default.font.family",
			"-font-family");

	public static String CL_OPTION_DEFAULT_FONT_FAMILY_DESCRIPTION = Messages
			.get("Main.cl.option.default.font.family.description", "No description");

	/**
	 * Option to specify the CSS alternate stylesheet when converting the SVG images
	 */
	public static String CL_OPTION_ALTERNATE_STYLESHEET = Messages.get("Main.cl.option.alternate.stylesheet",
			"-cssAlternate");

	public static String CL_OPTION_ALTERNATE_STYLESHEET_DESCRIPTION = Messages
			.get("Main.cl.option.alternate.stylesheet.description", "No description");

	/**
	 * Option to specify that the converted SVG files should be validated during the
	 * conversion process.
	 */
	public static String CL_OPTION_VALIDATE = Messages.get("Main.cl.option.validate", "-validate");

	public static String CL_OPTION_VALIDATE_DESCRIPTION = Messages.get("Main.cl.option.validate.description",
			"No description");

	/**
	 * Option to specify that the converted SVG files should be after the dispatch
	 * of the 'onload' event.
	 */
	public static String CL_OPTION_ONLOAD = Messages.get("Main.cl.option.onload", "-onload");

	public static String CL_OPTION_ONLOAD_DESCRIPTION = Messages.get("Main.cl.option.onload.description",
			"No description");

	/**
	 * Option to specify that the document should be rasterized after seeking to the
	 * specified document time.
	 */
	public static String CL_OPTION_SNAPSHOT_TIME = Messages.get("Main.cl.option.snapshot.time", "-snapshotTime");

	public static String CL_OPTION_SNAPSHOT_TIME_DESCRIPTION = Messages.get("Main.cl.option.snapshot.time.description",
			"No description");

	/**
	 * Option to specify the user language with which SVG documents should be
	 * processed
	 */
	public static String CL_OPTION_LANGUAGE = Messages.get("Main.cl.option.language", "-lang");

	public static String CL_OPTION_LANGUAGE_DESCRIPTION = Messages.get("Main.cl.option.language.description",
			"No description");
	...
	public static String CL_OPTION_USER_STYLESHEET_DESCRIPTION = Messages
			.get("Main.cl.option.user.stylesheet.description", "No description");
	...
	public static String CL_OPTION_QUALITY_DESCRIPTION = Messages.get("Main.cl.option.quality.description",
			"No description");
	...
	public static String CL_OPTION_INDEXED_DESCRIPTION = Messages.get("Main.cl.option.indexed.description",
			"No description");
	...
	public static String CL_OPTION_ALLOWED_SCRIPTS_DESCRIPTION = Messages
			.get("Main.cl.option.allowed.scripts.description", "No description");

	/**
	 * Option to determine whether scripts a constrained to the same origin as the
	 * document referencing them.
	 */
	public static String CL_OPTION_CONSTRAIN_SCRIPT_ORIGIN = Messages.get("Main.cl.option.constrain.script.origin",
			"-anyScriptOrigin");

	public static String CL_OPTION_CONSTRAIN_SCRIPT_ORIGIN_DESCRIPTION = Messages
			.get("Main.cl.option.constrain.script.origin.description", "No description");

	public static String CL_OPTION_ALLOW_EXTERNAL_RESOURCES = Messages.get("Main.cl.option.allow.external.resources",
			"-allowExternalResources");

	public static String CL_OPTION_ALLOW_EXTERNAL_RESOURCES_DESCRIPTION = Messages
			.get("Main.cl.option.allow.external.resources.description", "No description");
	...
	public static String CL_OPTION_SECURITY_OFF_DESCRIPTION = Messages.get("Main.cl.option.security.off.description",
			"No description");

	/**
	 * Static map containing all the option handlers able to analyze the various
	 * options.
	 */
	...
	/**
	 * Static initializer: adds all the option handlers to the map of option
	 * handlers.
	 */
	static {
		...
		optionMap.put(CL_OPTION_MIME_TYPE, new SingleValueOptionHandler() {
			@Override
			public void handleOption(String optionValue, SVGConverter c) {
				DestinationType dstType = mimeTypeMap.get(optionValue);
		...
		optionMap.put(CL_OPTION_ALLOW_EXTERNAL_RESOURCES, new NoValueOptionHandler() {
			@Override
			public void handleOption(SVGConverter c) {
	...
	/**
	 * Error when an illegal option value was passed to the app {0} Option {1}
	 * Option description
	 */
	...
	/**
	 * Template methods which subclasses may implement to do whatever is needed. For
	 * example, this can be used for test purposes.
	 */
	public void validateConverterConfig(SVGConverter c) {
	}

	/**
	 * Scans the input vector and replaces directories with the list of SVG files
	 * they contain
	 */
	...
	public boolean proceedWithSourceTranscoding(SVGConverterSource source, File dest) {
		System.out.print(Messages.formatMessage(MESSAGE_ABOUT_TO_TRANSCODE_SOURCE,
				new Object[] { source.toString(), dest.toString() }));
		return true;
	}
