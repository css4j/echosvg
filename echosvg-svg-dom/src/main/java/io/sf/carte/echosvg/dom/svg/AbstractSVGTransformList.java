...
/**
 * This class is the implementation of <code>SVGTransformList</code>.
 *
...
public abstract class AbstractSVGTransformList extends AbstractSVGList implements SVGTransformList {
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link SVGTransformList#insertItemBefore(SVGTransform,int)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link SVGTransformList#replaceItem(SVGTransform,int)}.
	 */
	@Override
	...
	/**
	 * <b>DOM</b>: Implements
	 * {@link SVGTransformList#createSVGTransformFromMatrix(SVGMatrix)}.
	 */
	@Override
	...
	/**
	 * Returns an {@link AffineTransform} that represents the same transform as that
	 * specified by this transform list.
	 */
	...
	public static class SVGTransformItem extends AbstractSVGTransform implements SVGItem {
		...
		/**
		 * Notifies the parent list that this item has changed. This also discards the
		 * cached representation of the item.
		 */
	...
	protected static class TransformListBuilder implements TransformListHandler {
		...
		/**
		 * The {@link ListHandler} to pass newly created {@link SVGTransformItem}
		 * objects to.
		 */
