...
/**
 * This class is the implementation of <code>SVGPathSegList</code>.
 *
...
public abstract class AbstractSVGPathSegList extends AbstractSVGList implements SVGPathSegList, SVGPathSegConstants {
	...
	public static class SVGPathSegMovetoLinetoItem extends SVGPathSegItem
			implements SVGPathSegMovetoAbs, SVGPathSegMovetoRel, SVGPathSegLinetoAbs, SVGPathSegLinetoRel {
	...
	public static class SVGPathSegCurvetoCubicItem extends SVGPathSegItem
		...
		public SVGPathSegCurvetoCubicItem(short type, String letter, float x1, float y1, float x2, float y2, float x,
				float y) {
			super(type, letter);
			this.setX(x);
			this.setY(y);
	...
	public static class SVGPathSegArcItem extends SVGPathSegItem implements SVGPathSegArcAbs, SVGPathSegArcRel {
		...
		public SVGPathSegArcItem(short type, String letter, float r1, float r2, float angle, boolean largeArcFlag,
	...
	protected static class PathSegListBuilder extends DefaultPathHandler {
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#movetoRel(float,float)}.
		 */
		@Override
		public void movetoRel(float x, float y) throws ParseException {
			listHandler.item(
					new SVGPathSegMovetoLinetoItem(SVGPathSeg.PATHSEG_MOVETO_REL, PATHSEG_MOVETO_REL_LETTER, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#movetoAbs(float,float)}.
		 */
		@Override
		public void movetoAbs(float x, float y) throws ParseException {
			listHandler.item(
					new SVGPathSegMovetoLinetoItem(SVGPathSeg.PATHSEG_MOVETO_ABS, PATHSEG_MOVETO_ABS_LETTER, x, y));
		}
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#linetoRel(float,float)}.
		 */
		@Override
		public void linetoRel(float x, float y) throws ParseException {
			listHandler.item(
					new SVGPathSegMovetoLinetoItem(SVGPathSeg.PATHSEG_LINETO_REL, PATHSEG_LINETO_REL_LETTER, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#linetoAbs(float,float)}.
		 */
		@Override
		public void linetoAbs(float x, float y) throws ParseException {
			listHandler.item(
					new SVGPathSegMovetoLinetoItem(SVGPathSeg.PATHSEG_LINETO_ABS, PATHSEG_LINETO_ABS_LETTER, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#linetoHorizontalRel(float)}.
		 */
		@Override
		public void linetoHorizontalRel(float x) throws ParseException {
			listHandler.item(new SVGPathSegLinetoHorizontalItem(SVGPathSeg.PATHSEG_LINETO_HORIZONTAL_REL,
					PATHSEG_LINETO_HORIZONTAL_REL_LETTER, x));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#linetoHorizontalAbs(float)}.
		 */
		@Override
		public void linetoHorizontalAbs(float x) throws ParseException {
			listHandler.item(new SVGPathSegLinetoHorizontalItem(SVGPathSeg.PATHSEG_LINETO_HORIZONTAL_ABS,
					PATHSEG_LINETO_HORIZONTAL_ABS_LETTER, x));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#linetoVerticalRel(float)}.
		 */
		@Override
		public void linetoVerticalRel(float y) throws ParseException {
			listHandler.item(new SVGPathSegLinetoVerticalItem(SVGPathSeg.PATHSEG_LINETO_VERTICAL_REL,
					PATHSEG_LINETO_VERTICAL_REL_LETTER, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#linetoVerticalAbs(float)}.
		 */
		@Override
		public void linetoVerticalAbs(float y) throws ParseException {
			listHandler.item(new SVGPathSegLinetoVerticalItem(SVGPathSeg.PATHSEG_LINETO_VERTICAL_ABS,
					PATHSEG_LINETO_VERTICAL_ABS_LETTER, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoCubicRel(float,float,float,float,float,float)}.
		 */
		@Override
		public void curvetoCubicRel(float x1, float y1, float x2, float y2, float x, float y) throws ParseException {
			listHandler.item(new SVGPathSegCurvetoCubicItem(SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL,
					PATHSEG_CURVETO_CUBIC_REL_LETTER, x1, y1, x2, y2, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoCubicAbs(float,float,float,float,float,float)}.
		 */
		@Override
		public void curvetoCubicAbs(float x1, float y1, float x2, float y2, float x, float y) throws ParseException {
			listHandler.item(new SVGPathSegCurvetoCubicItem(SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS,
					PATHSEG_CURVETO_CUBIC_ABS_LETTER, x1, y1, x2, y2, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoCubicSmoothRel(float,float,float,float)}.
		 */
		@Override
		public void curvetoCubicSmoothRel(float x2, float y2, float x, float y) throws ParseException {
			listHandler.item(new SVGPathSegCurvetoCubicSmoothItem(SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL,
					PATHSEG_CURVETO_CUBIC_SMOOTH_REL_LETTER, x2, y2, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoCubicSmoothAbs(float,float,float,float)}.
		 */
		@Override
		public void curvetoCubicSmoothAbs(float x2, float y2, float x, float y) throws ParseException {
			listHandler.item(new SVGPathSegCurvetoCubicSmoothItem(SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS,
					PATHSEG_CURVETO_CUBIC_SMOOTH_ABS_LETTER, x2, y2, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoQuadraticRel(float,float,float,float)}.
		 */
		@Override
		public void curvetoQuadraticRel(float x1, float y1, float x, float y) throws ParseException {
			listHandler.item(new SVGPathSegCurvetoQuadraticItem(SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_REL,
					PATHSEG_CURVETO_QUADRATIC_REL_LETTER, x1, y1, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoQuadraticAbs(float,float,float,float)}.
		 */
		@Override
		public void curvetoQuadraticAbs(float x1, float y1, float x, float y) throws ParseException {
			listHandler.item(new SVGPathSegCurvetoQuadraticItem(SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_ABS,
					PATHSEG_CURVETO_QUADRATIC_ABS_LETTER, x1, y1, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoQuadraticSmoothRel(float,float)}.
		 */
		@Override
		public void curvetoQuadraticSmoothRel(float x, float y) throws ParseException {
			listHandler.item(new SVGPathSegCurvetoQuadraticSmoothItem(SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL,
					PATHSEG_CURVETO_QUADRATIC_SMOOTH_REL_LETTER, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#curvetoQuadraticSmoothAbs(float,float)}.
		 */
		@Override
		...
		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#arcRel(float,float,float,boolean,boolean,float,float)}.
		 */
		@Override
		public void arcRel(float rx, float ry, float xAxisRotation, boolean largeArcFlag, boolean sweepFlag, float x,
			...
			listHandler.item(new SVGPathSegArcItem(SVGPathSeg.PATHSEG_ARC_REL, PATHSEG_ARC_REL_LETTER, rx, ry,
					xAxisRotation, largeArcFlag, sweepFlag, x, y));
		}

		/**
		 * Implements
		 * {@link io.sf.carte.echosvg.parser.PathHandler#arcAbs(float,float,float,boolean,boolean,float,float)}.
		 */
		@Override
