...
final class LinearGradientPaintContext extends MultipleGradientPaintContext {
	...
	/**
	 * The following invariants are used to process the gradient value from a device
	 * space coordinate, (X, Y): g(X, Y) = dgdX*X + dgdY*Y + gc
	 */
	 ...
	 *
	 */
	public LinearGradientPaintContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds, AffineTransform t,
			RenderingHints hints, Point2D dStart, Point2D dEnd, float[] fractions, Color[] colors,
	 ...
	 * This is where the area is filled with colors distributed linearly.
	 *
