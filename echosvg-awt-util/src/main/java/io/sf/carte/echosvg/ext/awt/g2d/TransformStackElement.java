...
public abstract class TransformStackElement implements Cloneable {
	...
	/**
	 * Implementation should determine if the parameter list represents an identity
	 * transform, for the instance transform type.
	 */
	 ...
	 * concatenated. For example, if this element represents a translation, it will
	 * concatenate with another translation, but not with any other kind of stack
	 * element.
	 * 
	 * @param stackElement element to be concatenated with this one.
	 * 
	 * @return true if the input stackElement was concatenated with this one. False
	 * otherwise.
	 */
