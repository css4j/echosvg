...
public interface CachableRed extends RenderedImage {
	 ...
	 * @return The region of input required. This is in the output pixel coordinate
	 *         system for the source indicated by srcIndex.
	 */
	 ...
	 *         of the source selected by srcIndex. this is in the output pixel
