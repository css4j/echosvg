...
public class AffineRed extends AbstractRed {
	...
	public void genRect(WritableRaster wr) {
		...
		// if ((count % 40) == 0) {
		// io.sf.carte.echosvg.ImageDisplay.showImage("Src: " , srcBI);
		// io.sf.carte.echosvg.ImageDisplay.showImage("Dst: " , myBI);
		// }
		// count++;
	}
	...
	protected static ColorModel fixColorModel(CachableRed src) {
		...
		for (int i = 0; i < b; i++)
			bits[i] = 8;
		return new ComponentColorModel(cs, bits, true, true, Transparency.TRANSLUCENT, DataBuffer.TYPE_INT);
