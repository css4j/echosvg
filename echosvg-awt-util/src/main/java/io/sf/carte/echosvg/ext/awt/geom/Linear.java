...
public class Linear implements Segment {
	...
	/**
	 * Subdivides this Linear segment into two segments at t = 0.5. can be done with
	...
	/**
	 * Subdivides this Cubic curve into two curves. Can be done with getSegment but
	 ...
	 * 
	 * public static void sub(Linear orig, Linear curr, double t, double inc, int
	 * lev) { Linear left=new Linear(); Linear right=new Linear();
	 ...
	 * 
	 * public static void eval(Linear l) { System.err.println("Length    : " +
	 * l.getLength()); }
	 * 
	 * 
	 * public static void main(String args[]) { Linear l;
	 * 
	 * l = new Linear(0,0, 30,0); sub(l, l, .5, .25, 3); eval(l);
	 * 
	 * l = new Linear(0,0, 0,30); sub(l, l, .5, .25, 3); eval(l);
	 * 
	 * l = new Linear(0,0, 20,30); sub(l, l, .5, .25, 3); eval(l); }
	 */
}
