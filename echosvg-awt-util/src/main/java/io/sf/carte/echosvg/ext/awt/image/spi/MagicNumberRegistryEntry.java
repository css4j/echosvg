...
public abstract class MagicNumberRegistryEntry extends AbstractRegistryEntry implements StreamRegistryEntry {
	...
	/**
	 * Inner class that represents one magic number. Simply consists of an offset in
	 * bytes from the start of the file, and a byte array that must match.
	 */
	public static class MagicNumber {
		...
		/**
		 * Returns the maximum number of bytes that will be read for this magic number
		 * comparison.
		 */
		int getReadlimit() {
	 ...
	 */
	public MagicNumberRegistryEntry(String name, float priority, String ext, String mimeType, int offset,
			byte[] magicNumber) {
	...
	/**
	 * Constructor, simplifies construction of entry when only one extension is
	 * required.
	 * 
	 * @param name         Format Name
	 * @param priority     the priority of the RegistryEntry
	 ...
	 */
	public MagicNumberRegistryEntry(String name, float priority, String ext, String mimeType,
			MagicNumber[] magicNumbers) {
		super(name, priority, ext, mimeType);
	...
	/**
	 * Constructor, simplifies construction of entry when only one magic number is
	 * required.
	 * 
	 * @param name        Format Name
	 * @param priority    the priority of the RegistryEntry
	 ...
	 * @param magicNumber byte array to match.
	 */
	public MagicNumberRegistryEntry(String name, float priority, String[] exts, String[] mimeTypes, int offset,
			byte[] magicNumber) {
	 ...
	 * @param magicNumbers array of magic numbers any of which can match.
	 */
	public MagicNumberRegistryEntry(String name, float priority, String[] exts, String[] mimeTypes,
			MagicNumber[] magicNumbers) {
		super(name, priority, exts, mimeTypes);
		this.magicNumbers = magicNumbers;
	}
	 ...
	 * entries. This should be needed very rarely since magic number checks are
	 * fairly relyable and hence aren't usually sensative to order issues.
	 * 
	 * @param name         Format Name
	 * @param exts         Standard set of extensions
	 * @param magicNumbers array of magic numbers any of which can match.
	...
	/**
	 * Check if the stream contains an image that can be handled by this format
	 * handler
	 */
	@Override
