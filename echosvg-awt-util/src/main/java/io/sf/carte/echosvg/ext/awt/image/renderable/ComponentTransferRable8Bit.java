...
import io.sf.carte.echosvg.ext.awt.image.DiscreteTransfer;
import io.sf.carte.echosvg.ext.awt.image.GammaTransfer;
import io.sf.carte.echosvg.ext.awt.image.IdentityTransfer;
import io.sf.carte.echosvg.ext.awt.image.LinearTransfer;
import io.sf.carte.echosvg.ext.awt.image.TableTransfer;
...
public class ComponentTransferRable8Bit extends AbstractColorInterpolationRable implements ComponentTransferRable {
	...
	public ComponentTransferRable8Bit(Filter src, ComponentTransferFunction alphaFunction,
			ComponentTransferFunction redFunction, ComponentTransferFunction greenFunction,
	...
	public RenderedImage createRendering(RenderContext rc) {
		...
		return new ComponentTransferRed(convertSourceCS(srcRI), getTransferFunctions(), rc.getRenderingHints());
	}
