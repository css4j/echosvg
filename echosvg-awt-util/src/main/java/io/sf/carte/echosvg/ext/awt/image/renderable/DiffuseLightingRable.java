 ...
 * The resulting image is an RGBA opaque image based on the light color with
 * alpha = 1.0 everywhere. The lighting calculation follows the standard diffuse
 ...
 *
 * This filter follows the specification of the feDiffuseLighting filter in the
