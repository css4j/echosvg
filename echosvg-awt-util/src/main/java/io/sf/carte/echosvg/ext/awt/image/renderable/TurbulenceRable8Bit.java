...
import io.sf.carte.echosvg.ext.awt.image.rendered.TurbulencePatternRed;
...
public class TurbulenceRable8Bit extends AbstractColorInterpolationRable implements TurbulenceRable {
	...
	public TurbulenceRable8Bit(Rectangle2D region, int seed, int numOctaves, double baseFreqX, double baseFreqY,
			boolean stitched, boolean fractalNoise) {
		super();
		this.seed = seed;
	...
	/**
	 * Returns true if the turbulence function is using fractal noise, instead of
	 * turbulence noise.
	 * 
	 * @return true if the turbulence function is using fractal noise, instead of
	 *         turbulence noise.
	 */
	@Override
	...
	public RenderedImage createRendering(RenderContext rc) {
		...
		// System.out.println("Scale X : " + usr2dev.getScaleX() + " scaleY : " +
		// usr2dev.getScaleY());
		// System.out.println("Turbulence aoi dev : " +
		...
		return new TurbulencePatternRed(baseFreqX, baseFreqY, numOctaves, seed, fractalNoise, tile, patternTxf, devRect,
				cs, true);
	}
}
