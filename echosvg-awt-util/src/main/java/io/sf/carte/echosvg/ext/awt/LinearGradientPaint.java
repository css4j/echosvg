 ...
 * and the last keyframe value equal to 1, keyframes will be created at these
 ...
 *
 * <p>
 * The user may also select what action the LinearGradientPaint should take when
 * filling color outside the start and end points. If no cycle method is
 * specified, NO_CYCLE will be chosen by default, so the endpoint colors will be
 * used to fill the remaining area.
 *
 * <p>
...
public final class LinearGradientPaint extends MultipleGradientPaint {
	...
	/**
	 * <p>
	 * Constructs an <code>LinearGradientPaint</code> with the default NO_CYCLE
	 * repeating method and SRGB colorspace.
	 *
	 * @param startX    the x coordinate of the gradient axis start point in user
	 *                  space
	 *
	 * @param startY    the y coordinate of the gradient axis start point in user
	 *                  space
	 *
	 * @param endX      the x coordinate of the gradient axis end point in user
	 *                  space
	 *
	 * @param endY      the y coordinate of the gradient axis end point in user
	 *                  space
	 *
	 * @param fractions numbers ranging from 0.0 to 1.0 specifying the distribution
	 *                  of colors along the gradient
	 *
	 * @param colors    array of colors corresponding to each fractional value
	 * 
	 *
	 * @throws IllegalArgumentException if start and end points are the same points,
	 *                                  or if fractions.length != colors.length, or
	 *                                  if colors is less than 2 in size.
	 *
	 */
	...
	/**
	 * <p>
	 * Constructs an <code>LinearGradientPaint</code> with default SRGB colorspace.
	 *
	 * @param startX      the x coordinate of the gradient axis start point in user
	 *                    space
	 *
	...
	/**
	 * <p>
	 * Constructs a <code>LinearGradientPaint</code> with the default NO_CYCLE
	 * repeating method and SRGB colorspace.
	 *
	 ...
	 * Constructs a <code>LinearGradientPaint</code>.
	 *
	 * @param start             the gradient axis start <code>Point</code> in user
	 *                          space
	 *
	 * @param end               the gradient axis end <code>Point</code> in user
	 *                          space
	 *
	 * @param fractions         numbers ranging from 0.0 to 1.0 specifying the
	 *                          distribution of colors along the gradient
	 *
	 * @param colors            array of colors corresponding to each fractional
	 *                          value
	 *
	 * @param cycleMethod       either NO_CYCLE, REFLECT, or REPEAT
	 *
	 * @param colorSpace        which colorspace to use for interpolation, either
	 *                          SRGB or LINEAR_RGB
	 *
	 * @param gradientTransform transform to apply to the gradient
	 * 
	 * @throws NullPointerException     if one of the points is null, or
	 ...
	 */
	public LinearGradientPaint(Point2D start, Point2D end, float[] fractions, Color[] colors,
			CycleMethodEnum cycleMethod, ColorSpaceEnum colorSpace, AffineTransform gradientTransform) {
	...
	/**
	 * Creates and returns a PaintContext used to generate the color pattern, for
	 * use by the internal rendering engine.
	 *
	 ...
	 *                     being rendered
	 *
	 * @param transform    the {@link AffineTransform} from user space into device
	 *                     space
	 *
	...
	public PaintContext createContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds,
		...
		try {
			return new LinearGradientPaintContext(cm, deviceBounds, userBounds, transform, hints, start, end, fractions,
					this.getColors(), cycleMethod, colorSpace);
		}
	 ...
	 * 
	 * @return a {@link Point2D} object that is a copy of the point that anchors the
	 *         first color of this <code>LinearGradientPaint</code>.
	 */
	 ...
	 * 
	 * @return a {@link Point2D} object that is a copy of the point that anchors the
	 *         last color of this <code>LinearGradientPaint</code>.
	 */
