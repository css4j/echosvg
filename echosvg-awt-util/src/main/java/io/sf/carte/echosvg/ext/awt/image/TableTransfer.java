...
public class TableTransfer implements TransferFunction {
	...
	/*
	 * This method will build the lut data. Each entry's value will
	 * increase/decrease between the nearby intervals.
	 */
	private void buildLutData() {
		...
		/*
		 * for (j=0; j<n; j++){ System.out.println("tableValues[" + j + "] = " +
		 * tableValues[j]); }
		 */
		...
		/*
		 * for(j=0; j<=255; j++){ System.out.print("[" + j + "] = " + (0xff &
		 * lutData[j]) + "  "); }
		 * 
