 ...
 * smoothly for any inbetween colors specified by the user. Any line drawn from
 * the focus point to the circumference will span the all the gradient colors.
...
public final class RadialGradientPaint extends MultipleGradientPaint {
	 ...
	 * <p>
	 *
	 * Constructs a <code>RadialGradientPaint</code>, using the center as the focus
	 * point.
	 *
	 ...
	 *
	 *
	 * @throws IllegalArgumentException if fractions.length != colors.length, or if
	 *                                  colors is less than 2 in size, or if radius
	 *                                  &lt; 0
	 *
	 *
	 */
	 ...
	 * Constructs a <code>RadialGradientPaint</code>.
	 *
	 * @param center            the center point in user space of the circle
	 *                          defining the gradient. The last color of the
	 ...
	 *                          distribution of colors along the gradient
	 *
	 * @param colors            array of colors to use in the gradient. The first
	 *                          color is used at the focus point, the last color
	 ...
	 * <p>
	 *
	 * Constructs a <code>RadialGradientPaint</code>, the gradient circle is defined
	 * by a bounding box.
	 *
	 * @param gradientBounds the bounding box, in user space, of the circle defining
	...
	public PaintContext createContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds,
		...
		try {
			return new RadialGradientPaintContext(cm, deviceBounds, userBounds, transform, hints, (float) center.getX(),
					(float) center.getY(), radius, (float) focus.getX(), (float) focus.getY(), fractions, colors,
