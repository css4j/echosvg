...
public class DiffuseLightingRed extends AbstractRed {
	...
	public DiffuseLightingRed(double kd, Light light, BumpMap bumpMap, Rectangle litRegion, double scaleX,
			double scaleY, boolean linear) {
		this.kd = kd;
		this.light = light;
	...
	public WritableRaster copyData(WritableRaster wr) {
		...
		// System.out.println("Getting diffuse red : " + minX + "/" + minY + "/" + w +
		// "/" + h);
