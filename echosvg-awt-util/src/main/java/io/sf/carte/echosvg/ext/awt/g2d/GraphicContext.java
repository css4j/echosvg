...
public class GraphicContext implements Cloneable {
	...
	/**
	 * Defines whether the transform stack is valide or not. This is for use by the
	 * class clients. The client should validate the stack every time it starts
	 * using it. The stack becomes invalid when a new transform is set.
	 * 
	...
	/**
	 * Marks the GraphicContext's isNewTransformStack to false as a memento that the
	 * current transform stack was read and has not been reset. Only the
	...
	/**
	 * Marks the GraphicContext's isNewTransformStack to true as a memento that the
	 * current transform stack was reset since it was last read. Only
