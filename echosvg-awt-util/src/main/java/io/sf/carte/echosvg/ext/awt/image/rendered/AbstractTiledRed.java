...
public abstract class AbstractTiledRed extends AbstractRed implements TileGenerator {
	 ...
	 * @param props  this initializes the props Map.
	 */
	protected AbstractTiledRed(CachableRed src, Rectangle bounds, ColorModel cm, SampleModel sm, Map<String, ?> props) {
	 ...
	 * @param props        this initializes the props Map.
	 */
	protected AbstractTiledRed(CachableRed src, Rectangle bounds, ColorModel cm, SampleModel sm, int tileGridXOff,
	 ...
	 */
	protected void init(CachableRed src, Rectangle bounds, ColorModel cm, SampleModel sm, int tileGridXOff,
			int tileGridYOff, TileStore tiles, Map<String, ?> props) {
	 ...
	 * @param props  this initializes the props Map.
	 */
	protected AbstractTiledRed(List<CachableRed> srcs, Rectangle bounds, ColorModel cm, SampleModel sm,
			Map<String, ?> props) {
	 ...
	 */
	protected AbstractTiledRed(List<CachableRed> srcs, Rectangle bounds, ColorModel cm, SampleModel sm,
			int tileGridXOff, int tileGridYOff, Map<String, ?> props) {
	...
	protected void drawBlockAndCopy(TileBlock[] blocks, WritableRaster wr) {
		...
		for (TileBlock curr : blocks) {
			...
			Rectangle tb = new Rectangle(xloc, yloc, curr.getWidth() * workTileWidth,
