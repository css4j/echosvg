...
public final class CompositeRule implements java.io.Serializable {
	...
	/**
	 * Porter-Duff Source Over Destination rule. The source is composited over the
	 * destination.
	 * 
	 * <pre>
	 *
	...
	/**
	 * Porter-Duff Source In Destination rule. The part of the source lying inside
	 * of the destination replaces the destination.
	 * 
	 * <pre>
	 *
	 *  Fs = Ad and Fd = 0, thus:
	...
	/**
	 * Porter-Duff Source Out Destination rule. The part of the source lying outside
	 * of the destination replaces the destination.
	 * 
	 * <pre>
	 *
	...
	/**
	 * Porter-Duff Source Atop Destination rule. The part of the source lying inside
	 * of the destination replaces the destination, destination remains outside of
	 * source.
	 * 
	 * <pre>
	 *
	...
	/**
	 * Factory to create artithmatic CompositeRules. 'out = k1*i1*i2 + k2*i1 + k3*i2
	 * + k4' Note that arithmatic CompositeRules are not singletons.
	 */
	 ...
	 * </pre>
	 */
	public static final CompositeRule MULTIPLY = new CompositeRule(RULE_MULTIPLY);
	 ...
	 * </pre>
	 */
	public static final CompositeRule SCREEN = new CompositeRule(RULE_SCREEN);
	 ...
	 * </pre>
	 */
	public static final CompositeRule DARKEN = new CompositeRule(RULE_DARKEN);
	 ...
	 * </pre>
	 */
	public static final CompositeRule LIGHTEN = new CompositeRule(RULE_LIGHTEN);
	...
	public String toString() {
		...
		case RULE_ARITHMETIC:
			return ("[CompositeRule: ARITHMATIC k1:" + k1 + " k2: " + k2 + " k3: " + k3 + " k4: " + k4 + ']');
		case RULE_MULTIPLY:
