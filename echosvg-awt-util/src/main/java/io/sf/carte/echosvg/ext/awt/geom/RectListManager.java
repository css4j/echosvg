...
public class RectListManager implements Collection<Rectangle> {
	...
	/**
	 * The comparator used to sort the elements of this List. Sorts on x value of
	 * Rectangle.
	 */
	 ...
	 * 
	 * @param rects Array of <code>Rectangles</code>, must not contain any null
	 *              entries.
	 */
	 ...
	 * 
	 * @param rects Array of <code>Rectangles</code>, must not contain any null
	 *              entries in the range [off, off+sz-1].
	...
	/**
	 * Construct an initially empty <code>RectListManager</code>, with initial
	 * <code>capacity</code>.
	 * 
	 * @param capacity The inital capacity for the list. Setting this appropriately
	 *                 can save reallocations.
	 */
	...
	/**
	 * Similar to clone only strongly typed TODO Java 5: The use of covariant return
	 * types on clone() can eliminate this method.
	 */
	...
	/**
	 * fill the given array a with values from my internal <code>rects</code>. when
	 * a is not large enough, a new array is allocated, filled and returned. the
	 * method works only, when a is a Object[] or a Rectange[]. When this is not the
	 * case, the a[] is just cleared.
	 *
	...
	/**
	 * Ensures that this collection contains the specified element l is the lower
	 * bound index for insertion r is upper bound index for insertion.
	 * 
	 * @param rect The rectangle to add
	 * @param l    the lowest possible index for a rect with greater 'x' coord.
	 * @param r    the highest possible index for a rect with greater 'x' coord.
	 */
	...
	/**
	 * Removes a single instance of the specified Rectangle from this collection, if
	 * it is present.
	 * 
	...
	/**
	 * Adds the contents of <code>rlm</code> to this RectListManager. No collapsing
	 * of rectangles is done here the contents are simply added (you should
	 * generally call 'mergeRects' some time after this operation before using the
	 * contents of this RectListManager.
	 * 
