...
public class JGridBagPanel extends JPanel implements GridBagConstants {
	...
	private static class DefaultInsetsManager implements InsetsManager {
		/**
		 * leftInset is the space used by default as a padding to the left of each grid
		 * cell.
		 */
		int leftInset = 5;

		/**
		 * topInset is the space used by default as a padding to the top of each grid
		 * cell.
		 */
		int topInset = 5;
	 ...
	 * positive cell coordinates. Top inset for components added to the top is 0.
	 * Left inset for components added to the left is 0. For compoents at index
	 * gridx more than zero and index gridy more than zero, the insets are set to a
	 * default value.
	 *
	 ...
	 * @param gridwidth  width, in cells, of the space occupied by the component in
	 *                   the grid
	 * @param gridheight height, in cells, of the space occupied by the component in
	 *                   the grid
	 * @param anchor     placement of the component in its allocated space: WEST,
	 *                   NORTH, SOUTH, NORTHWEST, ...
	 * @param fill       out should the component be resized within its space? NONE,
	 *                   BOTH, HORIZONTAL, VERTICAL.
	 * @param weightx    what amount of extra horizontal space, if any, should be
	 *                   given to this component?
	 * @param weighty    what amount of extra vertical space, if any, should be
	 *                   given to this component?
	 */
	public void add(Component cmp, int gridx, int gridy, int gridwidth, int gridheight, int anchor, int fill,
