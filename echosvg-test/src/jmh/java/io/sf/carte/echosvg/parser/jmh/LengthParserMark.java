...
/**
 * Check that there is no performance degradation in the length parser.
 *
 * @version $Id$
 */
@Threads(4)
...
public class LengthParserMark {
	...
	public void markParserCalc() {
		runParser("calc(2*4pc)");
		runParser("calc(2*2mm)");
	}
	...
	private class HandlerImpl extends DefaultLengthHandler {
