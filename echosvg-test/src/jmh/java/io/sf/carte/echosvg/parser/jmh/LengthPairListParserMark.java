...
/**
 * Check that there is no performance degradation in the length pair list parser.
 *
 * @version $Id$
 */
@Threads(4)
...
public class LengthPairListParserMark {

	@Benchmark
	public void markParser() {
		runParser("3 27; 8 43");
		runParser("3.1 27.1; 8.2 43.2");
	}

	@Benchmark
	public void markParserCalc() {
		runParser("3 27; calc(4 + 4) 43");
		runParser("3.1 27.2; calc(2.2*2.1) 43.4");
	}
