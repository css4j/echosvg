...
/**
 * This test validates the convertion of Java 2D TexturePaints into SVG patterns
 * and fill and fill-opacity values
 *
...
public class Texture implements Painter {
	...
	public void paint(Graphics2D g) {
		...
		String[] anchorDesc = { "Anchor matches texture image", "Anchor offset to texture image center",
