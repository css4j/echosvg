...
/**
 * This test validates the convertion of Java 2D paints into an SVG attributes.
 *
...
public class Paints implements Painter {
	...
	public void paint(Graphics2D g) {
		...
		GradientPaint fillGradient = new GradientPaint(10, 20, Color.red, 110, 80, Color.yellow);
		g.setPaint(defaultPaint);
