...
public interface EchoSVGExtConstants {
    ...
    /** Tag name for EchoSVG's regular poly extension. */
    String BATIK_EXT_REGULAR_POLYGON_TAG =
        "regularPolygon";

    /** Tag name for EchoSVG's star extension. */
    String BATIK_EXT_STAR_TAG =
        "star";

    /** Tag name for EchoSVG's color switch extension. */
    String BATIK_EXT_COLOR_SWITCH_TAG =
        "colorSwitch";

    /** Tag name for EchoSVG's histogram normalization extension. */
    ...
    /** Tag name for EchoSVG's flowText extension (SVG 1.2). */
    String BATIK_EXT_FLOW_TEXT_TAG =
        "flowText";

    /** Tag name for EchoSVG's flowText extension Region element (SVG 1.2). */
    ...
    /** Tag name for EchoSVG's flowText extension div element SVG 1.2). */
    String BATIK_EXT_FLOW_DIV_TAG =
        "flowDiv";

    /** Tag name for EchoSVG's flowText extension p element SVG 1.2). */
    String BATIK_EXT_FLOW_PARA_TAG =
        "flowPara";

    /** Tag name for EchoSVG's flowText extension flow Region break
     *  element SVG 1.2). */
    String BATIK_EXT_FLOW_REGION_BREAK_TAG =
        "flowRegionBreak";

    /** Tag name for EchoSVG's flowText extension line element SVG 1.2). */
    String BATIK_EXT_FLOW_LINE_TAG =
        "flowLine";

    /** Tag name for EchoSVG's flowText extension span element SVG 1.2). */
