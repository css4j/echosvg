 ...
 * @version $Id$
 */
public class EchoSVGRegularPolygonElementBridge extends SVGDecoratedShapeElementBridge implements EchoSVGExtConstants {

	/**
	 * Constructs a new bridge for the &lt;rect&gt; element.
	 */
	public EchoSVGRegularPolygonElementBridge() {
		/* nothing */ }
