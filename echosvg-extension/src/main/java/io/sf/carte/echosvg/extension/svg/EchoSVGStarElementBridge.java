 ...
 * @version $Id$
 */
public class EchoSVGStarElementBridge extends SVGDecoratedShapeElementBridge implements EchoSVGExtConstants {

	/**
	 * Constructs a new bridge for the &lt;rect&gt; element.
	 */
	public EchoSVGStarElementBridge() {
		/* nothing */ }
	...
	protected void buildShape(BridgeContext ctx, Element e, ShapeNode shapeNode) {
		...
		float ir;
		if (s.length() == 0)
			throw new BridgeException(ctx, e, ERR_ATTRIBUTE_MISSING, new Object[] { EXT_IR_ATTRIBUTE, s });

		ir = UnitProcessor.svgOtherLengthToUserSpace(s, EXT_IR_ATTRIBUTE, uctx);
