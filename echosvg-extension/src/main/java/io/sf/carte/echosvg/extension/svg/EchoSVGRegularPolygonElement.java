 ...
 * @version $Id$
 */
public class EchoSVGRegularPolygonElement extends GraphicsExtensionElement implements EchoSVGExtConstants {
	 ...
	 */
	protected EchoSVGRegularPolygonElement() {
	}
	 ...
	 */
	public EchoSVGRegularPolygonElement(String prefix, AbstractDocument owner) {
		super(prefix, owner);
	}
