...
parent directory, except they include the EchoSVG Extensions on the jar
file class path.  This means that that the EchoSVG Extensions will work
with the applications started by these jar files.

Great care should be used when using the EchoSVG Extensions as these are
